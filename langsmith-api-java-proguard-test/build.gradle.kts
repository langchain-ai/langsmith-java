...
dependencies {
    testImplementation(project(":langsmith-api-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../langsmith-api-java-core/src/main/resources/META-INF/proguard/langsmith-api-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.langsmith_api.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../langsmith-api-java-core/src/main/resources/META-INF/proguard/langsmith-api-java-core.pro",
