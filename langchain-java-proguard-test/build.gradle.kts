...
dependencies {
    testImplementation(project(":langchain-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../langchain-java-core/src/main/resources/META-INF/proguard/langchain-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.langchain.smith.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../langchain-java-core/src/main/resources/META-INF/proguard/langchain-java-core.pro",
