...
constructor(
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is
            AnnotationQueueSizeRetrieveParams && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    override fun toString() =
        "AnnotationQueueSizeRetrieveParams{queueId=$queueId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder { // templates/JavaSDK/entities/params.ts:235:14
        ...
        fun build(): AnnotationQueueSizeRetrieveParams =
            AnnotationQueueSizeRetrieveParams( // templates/JavaSDK/entities/params.ts:683:22
