...
constructor(
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is RunRetrieveParams && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    override fun toString() =
        "RunRetrieveParams{runId=$runId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder { // templates/JavaSDK/entities/params.ts:235:14
        ...
        internal fun from(runRetrieveParams: RunRetrieveParams) =
            apply { // templates/JavaSDK/entities/params.ts:257:34
                this.runId =
                    runRetrieveParams.runId // templates/JavaSDK/entities/params.ts:257:34 //
                // templates/JavaSDK/entities/params.ts:257:34
                additionalQueryParams(runRetrieveParams.additionalQueryParams)
                additionalHeaders(runRetrieveParams.additionalHeaders)
            }
        ...
        fun build(): RunRetrieveParams =
            RunRetrieveParams( // templates/JavaSDK/entities/params.ts:683:22
