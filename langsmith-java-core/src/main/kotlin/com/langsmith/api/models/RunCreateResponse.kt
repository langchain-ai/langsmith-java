...
@JsonDeserialize(
    builder = RunCreateResponse.Builder::class
...
private constructor(
    ...
    fun validate(): RunCreateResponse = apply { // templates/JavaSDK/entities/objects.ts:198:28
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is RunCreateResponse && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    class Builder { // templates/JavaSDK/entities/objects.ts:224:10 //
        ...
        internal fun from(runCreateResponse: RunCreateResponse) =
            apply { // templates/JavaSDK/entities/objects.ts:240:30
                additionalProperties(runCreateResponse.additionalProperties)
            }
        ...
        fun build(): RunCreateResponse = RunCreateResponse(additionalProperties.toUnmodifiable())
    }
}
