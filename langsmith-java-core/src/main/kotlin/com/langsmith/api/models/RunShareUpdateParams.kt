...
constructor( // templates/JavaSDK/entities/params.ts:131:13 //
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is RunShareUpdateParams && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    override fun toString() =
        "RunShareUpdateParams{runId=$runId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder { // templates/JavaSDK/entities/params.ts:235:14
        ...
        internal fun from(runShareUpdateParams: RunShareUpdateParams) =
            apply { // templates/JavaSDK/entities/params.ts:257:34
                this.runId =
                    runShareUpdateParams.runId // templates/JavaSDK/entities/params.ts:257:34 //
                // templates/JavaSDK/entities/params.ts:257:34
                additionalQueryParams(runShareUpdateParams.additionalQueryParams)
                additionalHeaders(runShareUpdateParams.additionalHeaders)
                additionalBodyProperties(runShareUpdateParams.additionalBodyProperties)
            }
        ...
        fun build(): RunShareUpdateParams =
            RunShareUpdateParams( // templates/JavaSDK/entities/params.ts:683:22
