...
constructor(
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is
            TenantCurrentMembersListParams && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    class Builder { // templates/JavaSDK/entities/params.ts:235:14
        ...
        internal fun from(tenantCurrentMembersListParams: TenantCurrentMembersListParams) =
            apply { // templates/JavaSDK/entities/params.ts:257:34
                additionalQueryParams(
                    tenantCurrentMembersListParams.additionalQueryParams
