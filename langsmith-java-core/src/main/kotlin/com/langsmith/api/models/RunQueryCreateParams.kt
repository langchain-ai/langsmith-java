...
constructor(
    ...
    @JvmSynthetic
    internal fun getBody(): RunQueryCreateBody {
        return RunQueryCreateBody(
            id,
            cursor,
            endTime,
            error,
    ...
    internal constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is RunQueryCreateBody &&
                this.id == other.id &&
        ...
        class Builder {
            ...
            @JvmSynthetic
            internal fun from(runQueryCreateBody: RunQueryCreateBody) = apply {
                this.id = runQueryCreateBody.id
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RunQueryCreateParams &&
            this.id == other.id &&
            this.cursor == other.cursor &&
            this.endTime == other.endTime &&
            this.error == other.error &&
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(runQueryCreateParams: RunQueryCreateParams) = apply {
            this.id(runQueryCreateParams.id ?: listOf())
