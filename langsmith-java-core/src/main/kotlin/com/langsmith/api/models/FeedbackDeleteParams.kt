...
constructor( // templates/JavaSDK/entities/params.ts:131:13 //
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is FeedbackDeleteParams && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    override fun toString() =
        "FeedbackDeleteParams{feedbackId=$feedbackId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder { // templates/JavaSDK/entities/params.ts:235:14
        ...
        internal fun from(feedbackDeleteParams: FeedbackDeleteParams) =
            apply { // templates/JavaSDK/entities/params.ts:257:34
                ...
                additionalQueryParams(feedbackDeleteParams.additionalQueryParams)
                additionalHeaders(feedbackDeleteParams.additionalHeaders)
                additionalBodyProperties(feedbackDeleteParams.additionalBodyProperties)
            }
        ...
        fun build(): FeedbackDeleteParams =
            FeedbackDeleteParams( // templates/JavaSDK/entities/params.ts:683:22
