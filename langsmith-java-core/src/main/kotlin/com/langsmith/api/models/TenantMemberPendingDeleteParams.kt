...
class TenantMemberPendingDeleteParams
constructor( // templates/JavaSDK/entities/params.ts:131:13 //
    // templates/JavaSDK/entities/params.ts:131:13 //
    // templates/JavaSDK/entities/params.ts:131:13 //
    // templates/JavaSDK/entities/params.ts:131:13
    private val identityId: String, // templates/JavaSDK/entities/params.ts:131:13 //
    // templates/JavaSDK/entities/params.ts:131:13
    ...
    fun identityId(): String = identityId // templates/JavaSDK/entities/params.ts:145:14 //
    // templates/JavaSDK/entities/params.ts:131:13
    ...
    fun getPathParam(index: Int): String { // templates/JavaSDK/entities/params.ts:555:13
        return when (index) { // templates/JavaSDK/entities/params.ts:560:26
            0 -> identityId // templates/JavaSDK/entities/params.ts:560:26 //
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is
            TenantMemberPendingDeleteParams && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    override fun hashCode(): Int { // templates/JavaSDK/entities/fields.ts:167:13
        return Objects.hash( // templates/JavaSDK/entities/fields.ts:163:19 //
            ...
            identityId, // templates/JavaSDK/entities/fields.ts:163:19
    ...
    override fun toString() =
        "TenantMemberPendingDeleteParams{identityId=$identityId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder { // templates/JavaSDK/entities/params.ts:235:14
        ...
        private var identityId: String? = null // templates/JavaSDK/entities/params.ts:238:20 //
        ...
        internal fun from(tenantMemberPendingDeleteParams: TenantMemberPendingDeleteParams) =
            apply { // templates/JavaSDK/entities/params.ts:257:34
                this.identityId =
                    tenantMemberPendingDeleteParams
                        .identityId // templates/JavaSDK/entities/params.ts:257:34 //
                // templates/JavaSDK/entities/params.ts:257:34
                additionalQueryParams(tenantMemberPendingDeleteParams.additionalQueryParams)
                additionalHeaders(tenantMemberPendingDeleteParams.additionalHeaders)
                additionalBodyProperties(tenantMemberPendingDeleteParams.additionalBodyProperties)
            }

        fun identityId(identityId: String) = apply { // templates/JavaSDK/entities/params.ts:634:26
        ...
        fun build(): TenantMemberPendingDeleteParams =
            TenantMemberPendingDeleteParams( // templates/JavaSDK/entities/params.ts:683:22
                checkNotNull(identityId) { // templates/JavaSDK/entities/params.ts:844:13 //
                    // templates/JavaSDK/entities/params.ts:683:22
                    "`identityId` is required but was not set"
                },
