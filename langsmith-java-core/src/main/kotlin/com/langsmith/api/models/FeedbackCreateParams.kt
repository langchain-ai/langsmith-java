...
constructor(
    ...
    @JvmSynthetic
    internal fun getBody(): FeedbackCreateBody {
        return FeedbackCreateBody(
            key,
            runId,
            id,
            comment,
    ...
    internal constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is FeedbackCreateBody &&
                this.key == other.key &&
        ...
        class Builder {
            ...
            @JvmSynthetic
            internal fun from(feedbackCreateBody: FeedbackCreateBody) = apply {
                this.key = feedbackCreateBody.key
    ...
    class Builder {
        ...
        internal fun from(feedbackCreateParams: FeedbackCreateParams) = apply {
            this.key = feedbackCreateParams.key
