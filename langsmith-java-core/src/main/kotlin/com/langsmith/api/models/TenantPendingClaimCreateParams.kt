...
class TenantPendingClaimCreateParams
constructor( // templates/JavaSDK/entities/params.ts:131:13 //
    // templates/JavaSDK/entities/params.ts:131:13 //
    // templates/JavaSDK/entities/params.ts:131:13 //
    // templates/JavaSDK/entities/params.ts:131:13
    private val tenantId: String, // templates/JavaSDK/entities/params.ts:131:13 //
    // templates/JavaSDK/entities/params.ts:131:13
    ...
    fun tenantId(): String = tenantId // templates/JavaSDK/entities/params.ts:145:14 //
    // templates/JavaSDK/entities/params.ts:131:13
    ...
    fun getPathParam(index: Int): String { // templates/JavaSDK/entities/params.ts:555:13
        return when (index) { // templates/JavaSDK/entities/params.ts:560:26
            0 -> tenantId // templates/JavaSDK/entities/params.ts:560:26 //
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is
            TenantPendingClaimCreateParams && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    override fun toString() =
        "TenantPendingClaimCreateParams{tenantId=$tenantId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder { // templates/JavaSDK/entities/params.ts:235:14
        ...
        private var tenantId: String? = null // templates/JavaSDK/entities/params.ts:238:20 //
        ...
        internal fun from(tenantPendingClaimCreateParams: TenantPendingClaimCreateParams) =
            apply { // templates/JavaSDK/entities/params.ts:257:34
                this.tenantId =
                    tenantPendingClaimCreateParams
                        .tenantId // templates/JavaSDK/entities/params.ts:257:34 //
                // templates/JavaSDK/entities/params.ts:257:34
                additionalQueryParams(tenantPendingClaimCreateParams.additionalQueryParams)
                additionalHeaders(tenantPendingClaimCreateParams.additionalHeaders)
                additionalBodyProperties(tenantPendingClaimCreateParams.additionalBodyProperties)
            }

        fun tenantId(tenantId: String) = apply { // templates/JavaSDK/entities/params.ts:634:26
        ...
        fun build(): TenantPendingClaimCreateParams =
            TenantPendingClaimCreateParams( // templates/JavaSDK/entities/params.ts:683:22
                checkNotNull(tenantId) { // templates/JavaSDK/entities/params.ts:844:13 //
