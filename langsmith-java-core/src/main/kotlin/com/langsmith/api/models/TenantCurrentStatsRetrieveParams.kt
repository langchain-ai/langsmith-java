...
constructor(
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is
            TenantCurrentStatsRetrieveParams && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    override fun toString() =
        "TenantCurrentStatsRetrieveParams{additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
        ...
        internal fun from(tenantCurrentStatsRetrieveParams: TenantCurrentStatsRetrieveParams) =
            apply { // templates/JavaSDK/entities/params.ts:257:34
                additionalQueryParams(
                    tenantCurrentStatsRetrieveParams.additionalQueryParams
