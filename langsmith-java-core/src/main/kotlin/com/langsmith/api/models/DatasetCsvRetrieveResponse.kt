...
@JsonDeserialize(
    builder = DatasetCsvRetrieveResponse.Builder::class
...
private constructor(
    ...
    fun validate(): DatasetCsvRetrieveResponse =
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is DatasetCsvRetrieveResponse && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    class Builder { // templates/JavaSDK/entities/objects.ts:224:10 //
        ...
        internal fun from(datasetCsvRetrieveResponse: DatasetCsvRetrieveResponse) =
