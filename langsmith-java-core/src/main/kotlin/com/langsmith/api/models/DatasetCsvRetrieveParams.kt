...
constructor( // templates/JavaSDK/entities/params.ts:131:13 //
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is DatasetCsvRetrieveParams && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    override fun toString() =
        "DatasetCsvRetrieveParams{datasetId=$datasetId, asOf=$asOf, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder { // templates/JavaSDK/entities/params.ts:235:14
        ...
        internal fun from(datasetCsvRetrieveParams: DatasetCsvRetrieveParams) =
        ...
        fun build(): DatasetCsvRetrieveParams =
            DatasetCsvRetrieveParams( // templates/JavaSDK/entities/params.ts:683:22
