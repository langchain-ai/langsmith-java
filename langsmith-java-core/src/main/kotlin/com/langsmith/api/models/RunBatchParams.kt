...
constructor(
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is RunBatchParams && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    override fun hashCode(): Int { // templates/JavaSDK/entities/fields.ts:167:13
        return Objects.hash( // templates/JavaSDK/entities/fields.ts:163:19 //
            ...
            additionalQueryParams, // templates/JavaSDK/entities/fields.ts:163:19
            additionalHeaders,
    ...
    override fun toString() =
        "RunBatchParams{additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder { // templates/JavaSDK/entities/params.ts:235:14
        ...
        internal fun from(runBatchParams: RunBatchParams) =
            apply { // templates/JavaSDK/entities/params.ts:257:34
                additionalQueryParams(
                    runBatchParams.additionalQueryParams
                ) // templates/JavaSDK/entities/params.ts:257:34 //
                // templates/JavaSDK/entities/params.ts:257:34
                additionalHeaders(runBatchParams.additionalHeaders)
                additionalBodyProperties(runBatchParams.additionalBodyProperties)
            }
        ...
        fun build(): RunBatchParams =
            RunBatchParams( // templates/JavaSDK/entities/params.ts:683:22
                additionalQueryParams
                    .mapValues { it.value.toUnmodifiable() }
                    .toUnmodifiable(), // templates/JavaSDK/entities/params.ts:683:22
