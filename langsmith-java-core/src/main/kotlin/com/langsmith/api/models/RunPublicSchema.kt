...
@JsonDeserialize(
    builder = RunPublicSchema.Builder::class
...
private constructor( // templates/JavaSDK/entities/objects.ts:76:13
    ...
    fun validate(): RunPublicSchema = apply { // templates/JavaSDK/entities/objects.ts:198:28
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is RunPublicSchema && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    override fun toString() =
        "RunPublicSchema{name=$name, inputs=$inputs, runType=$runType, startTime=$startTime, endTime=$endTime, extra=$extra, error=$error, executionOrder=$executionOrder, serialized=$serialized, outputs=$outputs, parentRunId=$parentRunId, manifestId=$manifestId, manifestS3Id=$manifestS3Id, events=$events, tags=$tags, inputsS3Urls=$inputsS3Urls, outputsS3Urls=$outputsS3Urls, traceId=$traceId, dottedOrder=$dottedOrder, id=$id, status=$status, childRunIds=$childRunIds, directChildRunIds=$directChildRunIds, parentRunIds=$parentRunIds, feedbackStats=$feedbackStats, referenceExampleId=$referenceExampleId, totalTokens=$totalTokens, promptTokens=$promptTokens, completionTokens=$completionTokens, totalCost=$totalCost, promptCost=$promptCost, completionCost=$completionCost, firstTokenTime=$firstTokenTime, additionalProperties=$additionalProperties}"
    ...
    class Builder { // templates/JavaSDK/entities/objects.ts:224:10 //
        ...
        internal fun from(runPublicSchema: RunPublicSchema) =
            apply { // templates/JavaSDK/entities/objects.ts:240:30
                this.name = runPublicSchema.name // templates/JavaSDK/entities/objects.ts:240:30 //
                // templates/JavaSDK/entities/objects.ts:240:30
                this.inputs = runPublicSchema.inputs
                this.runType = runPublicSchema.runType
                this.startTime = runPublicSchema.startTime
                this.endTime = runPublicSchema.endTime
                this.extra = runPublicSchema.extra
                this.error = runPublicSchema.error
                this.executionOrder = runPublicSchema.executionOrder
                this.serialized = runPublicSchema.serialized
                this.outputs = runPublicSchema.outputs
                this.parentRunId = runPublicSchema.parentRunId
                this.manifestId = runPublicSchema.manifestId
                this.manifestS3Id = runPublicSchema.manifestS3Id
                this.events = runPublicSchema.events
                this.tags = runPublicSchema.tags
                this.inputsS3Urls = runPublicSchema.inputsS3Urls
                this.outputsS3Urls = runPublicSchema.outputsS3Urls
                this.traceId = runPublicSchema.traceId
                this.dottedOrder = runPublicSchema.dottedOrder
                this.id = runPublicSchema.id
                this.status = runPublicSchema.status
                this.childRunIds = runPublicSchema.childRunIds
                this.directChildRunIds = runPublicSchema.directChildRunIds
                this.parentRunIds = runPublicSchema.parentRunIds
                this.feedbackStats = runPublicSchema.feedbackStats
                this.referenceExampleId = runPublicSchema.referenceExampleId
                this.totalTokens = runPublicSchema.totalTokens
                this.promptTokens = runPublicSchema.promptTokens
                this.completionTokens = runPublicSchema.completionTokens
                this.totalCost = runPublicSchema.totalCost
                this.promptCost = runPublicSchema.promptCost
                this.completionCost = runPublicSchema.completionCost
                this.firstTokenTime = runPublicSchema.firstTokenTime
                additionalProperties(runPublicSchema.additionalProperties)
            }
        ...
        fun build(): RunPublicSchema =
            RunPublicSchema( // templates/JavaSDK/entities/objects.ts:326:30
