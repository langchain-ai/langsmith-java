...
constructor(
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is RunShareRetrieveParams && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    override fun toString() =
        "RunShareRetrieveParams{runId=$runId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder { // templates/JavaSDK/entities/params.ts:235:14
        ...
        internal fun from(runShareRetrieveParams: RunShareRetrieveParams) =
            apply { // templates/JavaSDK/entities/params.ts:257:34
                this.runId =
                    runShareRetrieveParams.runId // templates/JavaSDK/entities/params.ts:257:34 //
                // templates/JavaSDK/entities/params.ts:257:34
                additionalQueryParams(runShareRetrieveParams.additionalQueryParams)
                additionalHeaders(runShareRetrieveParams.additionalHeaders)
            }
        ...
        fun build(): RunShareRetrieveParams =
            RunShareRetrieveParams( // templates/JavaSDK/entities/params.ts:683:22
