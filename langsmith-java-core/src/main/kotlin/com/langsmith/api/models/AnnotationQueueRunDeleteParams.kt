...
class AnnotationQueueRunDeleteParams
constructor( // templates/JavaSDK/entities/params.ts:131:13 //
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is
            AnnotationQueueRunDeleteParams && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    override fun toString() =
        "AnnotationQueueRunDeleteParams{queueId=$queueId, queueRunId=$queueRunId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder { // templates/JavaSDK/entities/params.ts:235:14
        ...
        internal fun from(annotationQueueRunDeleteParams: AnnotationQueueRunDeleteParams) =
            apply { // templates/JavaSDK/entities/params.ts:257:34
                this.queueId =
                    annotationQueueRunDeleteParams
                        .queueId // templates/JavaSDK/entities/params.ts:257:34 //
                // templates/JavaSDK/entities/params.ts:257:34
                this.queueRunId = annotationQueueRunDeleteParams.queueRunId
                additionalQueryParams(annotationQueueRunDeleteParams.additionalQueryParams)
                additionalHeaders(annotationQueueRunDeleteParams.additionalHeaders)
                additionalBodyProperties(annotationQueueRunDeleteParams.additionalBodyProperties)
            }
        ...
        fun build(): AnnotationQueueRunDeleteParams =
            AnnotationQueueRunDeleteParams( // templates/JavaSDK/entities/params.ts:683:22
