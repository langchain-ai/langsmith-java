...
constructor( // templates/JavaSDK/entities/params.ts:131:13 //
    ...
    // templates/JavaSDK/entities/params.ts:131:13 //
    // templates/JavaSDK/entities/params.ts:131:13
    private val apiKeyId: String, // templates/JavaSDK/entities/params.ts:131:13 //
    // templates/JavaSDK/entities/params.ts:131:13
    ...
    fun apiKeyId(): String = apiKeyId // templates/JavaSDK/entities/params.ts:145:14 //
    // templates/JavaSDK/entities/params.ts:131:13
    ...
    fun getPathParam(index: Int): String { // templates/JavaSDK/entities/params.ts:555:13
        return when (index) { // templates/JavaSDK/entities/params.ts:560:26
            0 -> apiKeyId // templates/JavaSDK/entities/params.ts:560:26 //
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is ApiKeyDeleteParams && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    override fun hashCode(): Int { // templates/JavaSDK/entities/fields.ts:167:13
        return Objects.hash( // templates/JavaSDK/entities/fields.ts:163:19 //
            ...
            apiKeyId, // templates/JavaSDK/entities/fields.ts:163:19
    ...
    override fun toString() =
        "ApiKeyDeleteParams{apiKeyId=$apiKeyId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder { // templates/JavaSDK/entities/params.ts:235:14
        ...
        private var apiKeyId: String? = null // templates/JavaSDK/entities/params.ts:238:20 //
        ...
        internal fun from(apiKeyDeleteParams: ApiKeyDeleteParams) =
            apply { // templates/JavaSDK/entities/params.ts:257:34
                this.apiKeyId =
                    apiKeyDeleteParams.apiKeyId // templates/JavaSDK/entities/params.ts:257:34 //
                // templates/JavaSDK/entities/params.ts:257:34
                additionalQueryParams(apiKeyDeleteParams.additionalQueryParams)
                additionalHeaders(apiKeyDeleteParams.additionalHeaders)
                additionalBodyProperties(apiKeyDeleteParams.additionalBodyProperties)
            }

        fun apiKeyId(apiKeyId: String) = apply { // templates/JavaSDK/entities/params.ts:634:26
        ...
        fun build(): ApiKeyDeleteParams =
            ApiKeyDeleteParams( // templates/JavaSDK/entities/params.ts:683:22
                checkNotNull(apiKeyId) { // templates/JavaSDK/entities/params.ts:844:13 //
                    // templates/JavaSDK/entities/params.ts:683:22
                    "`apiKeyId` is required but was not set"
                },
