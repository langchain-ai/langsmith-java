...
constructor(
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is RunCreateParams && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    override fun toString() =
        "RunCreateParams{additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder { // templates/JavaSDK/entities/params.ts:235:14
        ...
        internal fun from(runCreateParams: RunCreateParams) =
            apply { // templates/JavaSDK/entities/params.ts:257:34
                ...
                // templates/JavaSDK/entities/params.ts:257:34
                additionalHeaders(runCreateParams.additionalHeaders)
                additionalBodyProperties(runCreateParams.additionalBodyProperties)
            }
        ...
        fun build(): RunCreateParams =
            RunCreateParams( // templates/JavaSDK/entities/params.ts:683:22
                additionalQueryParams
