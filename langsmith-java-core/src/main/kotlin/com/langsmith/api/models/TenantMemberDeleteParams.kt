...
class TenantMemberDeleteParams
constructor( // templates/JavaSDK/entities/params.ts:131:13 //
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is TenantMemberDeleteParams && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    override fun toString() =
        "TenantMemberDeleteParams{identityId=$identityId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder { // templates/JavaSDK/entities/params.ts:235:14
        ...
        internal fun from(tenantMemberDeleteParams: TenantMemberDeleteParams) =
            apply { // templates/JavaSDK/entities/params.ts:257:34
                this.identityId =
                    tenantMemberDeleteParams
                        .identityId // templates/JavaSDK/entities/params.ts:257:34 //
                // templates/JavaSDK/entities/params.ts:257:34
                additionalQueryParams(tenantMemberDeleteParams.additionalQueryParams)
                additionalHeaders(tenantMemberDeleteParams.additionalHeaders)
                additionalBodyProperties(tenantMemberDeleteParams.additionalBodyProperties)
            }
        ...
        fun build(): TenantMemberDeleteParams =
            TenantMemberDeleteParams( // templates/JavaSDK/entities/params.ts:683:22
