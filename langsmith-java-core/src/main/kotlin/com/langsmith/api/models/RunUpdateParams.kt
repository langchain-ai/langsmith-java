...
constructor( // templates/JavaSDK/entities/params.ts:131:13 //
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is RunUpdateParams && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    override fun toString() =
        "RunUpdateParams{runId=$runId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder { // templates/JavaSDK/entities/params.ts:235:14
        ...
        internal fun from(runUpdateParams: RunUpdateParams) =
            apply { // templates/JavaSDK/entities/params.ts:257:34
                this.runId = runUpdateParams.runId // templates/JavaSDK/entities/params.ts:257:34 //
                // templates/JavaSDK/entities/params.ts:257:34
                additionalQueryParams(runUpdateParams.additionalQueryParams)
                additionalHeaders(runUpdateParams.additionalHeaders)
                additionalBodyProperties(runUpdateParams.additionalBodyProperties)
            }
        ...
        fun build(): RunUpdateParams =
            RunUpdateParams( // templates/JavaSDK/entities/params.ts:683:22
