...
private constructor( // templates/JavaSDK/entities/objects.ts:76:13
    ...
    fun validate(): TenantForUser = apply { // templates/JavaSDK/entities/objects.ts:198:28
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is TenantForUser && // templates/JavaSDK/entities/fields.ts:143:33
            this.id == other.id &&
    ...
    class Builder { // templates/JavaSDK/entities/objects.ts:224:10 //
        ...
        internal fun from(tenantForUser: TenantForUser) =
            apply { // templates/JavaSDK/entities/objects.ts:240:30
                this.id = tenantForUser.id // templates/JavaSDK/entities/objects.ts:240:30 //
