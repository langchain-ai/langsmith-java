...
@JsonDeserialize(
    builder = ListPublicDatasetRunsResponse.Builder::class
...
private constructor( // templates/JavaSDK/entities/objects.ts:76:13
    private val runs:
        JsonField<List<RunPublicDatasetSchema>>, // templates/JavaSDK/entities/objects.ts:76:13 //
    // templates/JavaSDK/entities/objects.ts:76:13
    ...
    fun validate(): ListPublicDatasetRunsResponse =
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is
            ListPublicDatasetRunsResponse && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    class Builder { // templates/JavaSDK/entities/objects.ts:224:10 //
        ...
        private var runs: JsonField<List<RunPublicDatasetSchema>> =
        ...
        internal fun from(listPublicDatasetRunsResponse: ListPublicDatasetRunsResponse) =
            apply { // templates/JavaSDK/entities/objects.ts:240:30
                this.runs =
                    listPublicDatasetRunsResponse
                        .runs // templates/JavaSDK/entities/objects.ts:240:30 //
