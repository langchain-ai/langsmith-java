...
@JsonDeserialize(builder = DatasetOpenAIRetrieveResponse.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    fun validate(): DatasetOpenAIRetrieveResponse = apply {
        if (!validated) {
            validated = true
        }
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DatasetOpenAIRetrieveResponse &&
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(datasetOpenAIRetrieveResponse: DatasetOpenAIRetrieveResponse) = apply {
