...
constructor(
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is DatasetRetrieveParams && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    class Builder { // templates/JavaSDK/entities/params.ts:235:14
        ...
        internal fun from(datasetRetrieveParams: DatasetRetrieveParams) =
        ...
        fun build(): DatasetRetrieveParams =
            DatasetRetrieveParams( // templates/JavaSDK/entities/params.ts:683:22
