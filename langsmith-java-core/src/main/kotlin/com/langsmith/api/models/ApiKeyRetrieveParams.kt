...
constructor(
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is ApiKeyRetrieveParams && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    override fun toString() =
        "ApiKeyRetrieveParams{additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder { // templates/JavaSDK/entities/params.ts:235:14
        ...
        internal fun from(apiKeyRetrieveParams: ApiKeyRetrieveParams) =
            apply { // templates/JavaSDK/entities/params.ts:257:34
                additionalQueryParams(
                    apiKeyRetrieveParams.additionalQueryParams
