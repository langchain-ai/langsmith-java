...
class RunGenerateQueryCreateParams
constructor( // templates/JavaSDK/entities/params.ts:131:13 //
    // templates/JavaSDK/entities/params.ts:131:13 //
    // templates/JavaSDK/entities/params.ts:131:13 //
    // templates/JavaSDK/entities/params.ts:131:13
    private val query: String, // templates/JavaSDK/entities/params.ts:131:13 //
    // templates/JavaSDK/entities/params.ts:131:13
    ...
    fun query(): String = query // templates/JavaSDK/entities/params.ts:145:14 //
    // templates/JavaSDK/entities/params.ts:131:13

    @JvmSynthetic // templates/JavaSDK/entities/params.ts:165:16
    internal fun getBody():
        RunGenerateQueryCreateBody { // templates/JavaSDK/entities/params.ts:165:16
        return RunGenerateQueryCreateBody(query, additionalBodyProperties)
    }
    ...
    @JsonDeserialize(
        builder = RunGenerateQueryCreateBody.Builder::class
    ) // templates/JavaSDK/entities/objects.ts:76:13 // templates/JavaSDK/entities/objects.ts:76:13
    // // templates/JavaSDK/entities/objects.ts:76:13 //
    // templates/JavaSDK/entities/objects.ts:76:13 // templates/JavaSDK/entities/objects.ts:76:13
    @NoAutoDetect
    class RunGenerateQueryCreateBody
    internal constructor(
        ...
        override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
            ...
            return other is
                RunGenerateQueryCreateBody && // templates/JavaSDK/entities/fields.ts:143:33
        ...
        override fun hashCode(): Int { // templates/JavaSDK/entities/fields.ts:167:13
            if (hashCode == 0) { // templates/JavaSDK/entities/fields.ts:175:16 //
                ...
                // templates/JavaSDK/entities/fields.ts:174:16
                hashCode = Objects.hash(query, additionalProperties)
            }
            return hashCode
        }

        override fun toString() =
            "RunGenerateQueryCreateBody{query=$query, additionalProperties=$additionalProperties}"
        ...
        class Builder { // templates/JavaSDK/entities/objects.ts:224:10 //
            ...
            private var query: String? = null // templates/JavaSDK/entities/objects.ts:226:16 //
            // templates/JavaSDK/entities/objects.ts:226:16 //
            // templates/JavaSDK/entities/objects.ts:224:10
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            @JvmSynthetic // templates/JavaSDK/entities/objects.ts:234:14
            internal fun from(runGenerateQueryCreateBody: RunGenerateQueryCreateBody) =
                apply { // templates/JavaSDK/entities/objects.ts:240:30
                    this.query =
                        runGenerateQueryCreateBody
                            .query // templates/JavaSDK/entities/objects.ts:240:30 //
                    // templates/JavaSDK/entities/objects.ts:240:30
                    additionalProperties(runGenerateQueryCreateBody.additionalProperties)
                }
            ...
            fun build(): RunGenerateQueryCreateBody =
                RunGenerateQueryCreateBody(
                    checkNotNull(query) { // templates/JavaSDK/entities/objects.ts:358:13 //
                        // templates/JavaSDK/entities/objects.ts:326:30
                        "`query` is required but was not set"
                    },
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is
            RunGenerateQueryCreateParams && // templates/JavaSDK/entities/fields.ts:143:33
            this.query == other.query &&
    ...
    override fun hashCode(): Int { // templates/JavaSDK/entities/fields.ts:167:13
        return Objects.hash( // templates/JavaSDK/entities/fields.ts:163:19 //
            ...
            query, // templates/JavaSDK/entities/fields.ts:163:19
    ...
    override fun toString() =
        "RunGenerateQueryCreateParams{query=$query, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder { // templates/JavaSDK/entities/params.ts:235:14
        ...
        private var query: String? = null // templates/JavaSDK/entities/params.ts:238:20 //
        ...
        internal fun from(runGenerateQueryCreateParams: RunGenerateQueryCreateParams) =
            apply { // templates/JavaSDK/entities/params.ts:257:34
                this.query =
                    runGenerateQueryCreateParams
                        .query // templates/JavaSDK/entities/params.ts:257:34 //
                // templates/JavaSDK/entities/params.ts:257:34
                additionalQueryParams(runGenerateQueryCreateParams.additionalQueryParams)
                additionalHeaders(runGenerateQueryCreateParams.additionalHeaders)
                additionalBodyProperties(runGenerateQueryCreateParams.additionalBodyProperties)
            }
        ...
        fun build(): RunGenerateQueryCreateParams =
            RunGenerateQueryCreateParams( // templates/JavaSDK/entities/params.ts:683:22
                checkNotNull(query) { // templates/JavaSDK/entities/params.ts:844:13 //
