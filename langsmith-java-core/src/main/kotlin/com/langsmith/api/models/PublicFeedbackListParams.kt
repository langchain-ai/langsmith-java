...
constructor(
    ...
    override fun toString() =
        "PublicFeedbackListParams{shareToken=$shareToken, hasComment=$hasComment, hasScore=$hasScore, key=$key, limit=$limit, offset=$offset, run=$run, session=$session, source=$source, user=$user, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(publicFeedbackListParams: PublicFeedbackListParams) = apply {
            ...
            additionalBodyProperties(publicFeedbackListParams.additionalBodyProperties)
        }
