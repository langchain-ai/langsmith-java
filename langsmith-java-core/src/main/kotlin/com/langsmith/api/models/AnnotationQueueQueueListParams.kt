...
class AnnotationQueueQueueListParams
constructor(
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is
            AnnotationQueueQueueListParams && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    override fun toString() =
        "AnnotationQueueQueueListParams{runId=$runId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder { // templates/JavaSDK/entities/params.ts:235:14
        ...
        internal fun from(annotationQueueQueueListParams: AnnotationQueueQueueListParams) =
            apply { // templates/JavaSDK/entities/params.ts:257:34
                this.runId =
                    annotationQueueQueueListParams
                        .runId // templates/JavaSDK/entities/params.ts:257:34 //
                // templates/JavaSDK/entities/params.ts:257:34
                additionalQueryParams(annotationQueueQueueListParams.additionalQueryParams)
                additionalHeaders(annotationQueueQueueListParams.additionalHeaders)
            }
        ...
        fun build(): AnnotationQueueQueueListParams =
            AnnotationQueueQueueListParams( // templates/JavaSDK/entities/params.ts:683:22
