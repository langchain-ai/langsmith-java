...
class TenantPendingDeleteParams
constructor( // templates/JavaSDK/entities/params.ts:131:13 //
    ...
    fun id(): String = id // templates/JavaSDK/entities/params.ts:145:14 //
    // templates/JavaSDK/entities/params.ts:131:13
    ...
    fun getPathParam(index: Int): String { // templates/JavaSDK/entities/params.ts:555:13
        return when (index) { // templates/JavaSDK/entities/params.ts:560:26
            0 -> id // templates/JavaSDK/entities/params.ts:560:26 //
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is TenantPendingDeleteParams && // templates/JavaSDK/entities/fields.ts:143:33
            this.id == other.id &&
    ...
    override fun toString() =
        "TenantPendingDeleteParams{id=$id, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder { // templates/JavaSDK/entities/params.ts:235:14
        ...
        internal fun from(tenantPendingDeleteParams: TenantPendingDeleteParams) =
            apply { // templates/JavaSDK/entities/params.ts:257:34
                this.id =
                    tenantPendingDeleteParams.id // templates/JavaSDK/entities/params.ts:257:34 //
                // templates/JavaSDK/entities/params.ts:257:34
                additionalQueryParams(tenantPendingDeleteParams.additionalQueryParams)
                additionalHeaders(tenantPendingDeleteParams.additionalHeaders)
                additionalBodyProperties(tenantPendingDeleteParams.additionalBodyProperties)
            }
        ...
        fun build(): TenantPendingDeleteParams =
            TenantPendingDeleteParams( // templates/JavaSDK/entities/params.ts:683:22
                checkNotNull(id) { // templates/JavaSDK/entities/params.ts:844:13 //
