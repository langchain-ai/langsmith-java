...
constructor( // templates/JavaSDK/entities/params.ts:131:13 //
    ...
    internal fun getQueryParams():
        ...
        this.shareProjects?.let { // templates/JavaSDK/entities/objects.ts:462:15
            params.put("share_projects", listOf(it.toString()))
        }
    ...
    override fun equals(other: Any?): Boolean { // templates/JavaSDK/entities/fields.ts:131:6
        ...
        return other is DatasetShareUpdateParams && // templates/JavaSDK/entities/fields.ts:143:33
    ...
    class Builder { // templates/JavaSDK/entities/params.ts:235:14
        ...
        internal fun from(datasetShareUpdateParams: DatasetShareUpdateParams) =
        ...
        fun shareProjects(shareProjects: Boolean) =
        ...
        fun build(): DatasetShareUpdateParams =
            DatasetShareUpdateParams( // templates/JavaSDK/entities/params.ts:683:22
