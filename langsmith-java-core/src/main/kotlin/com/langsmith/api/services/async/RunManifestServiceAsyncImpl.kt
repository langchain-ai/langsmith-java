...
class RunManifestServiceAsyncImpl
constructor(
    private val clientOptions: ClientOptions,
) : RunManifestServiceAsync { // templates/JavaSDK/services.ts:76:15 //
    ...
    ): CompletableFuture<RunManifestSchema> { // templates/JavaSDK/services.ts:831:10
        val request =
