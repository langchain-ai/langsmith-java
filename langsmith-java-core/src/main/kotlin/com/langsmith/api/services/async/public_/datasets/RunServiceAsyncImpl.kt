...
import com.langsmith.api.services.async.public_.datasets.runs.QueryServiceAsyncImpl
import com.langsmith.api.services.async.public_.datasets.runs.StatServiceAsync
import com.langsmith.api.services.async.public_.datasets.runs.StatServiceAsyncImpl
...
constructor(
    ...
    ): CompletableFuture<RunPublicDatasetSchema> { // templates/JavaSDK/services.ts:831:10
        val request =
