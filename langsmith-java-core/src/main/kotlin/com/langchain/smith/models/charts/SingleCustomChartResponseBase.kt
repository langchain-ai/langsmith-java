...
class SingleCustomChartResponseBase
...
private constructor(
    ...
    /** A builder for [SingleCustomChartResponseBase]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(singleCustomChartResponseBase: SingleCustomChartResponseBase) = apply {
            data = singleCustomChartResponseBase.data.map { it.toMutableList() }
            additionalProperties = singleCustomChartResponseBase.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SingleCustomChartResponseBase].
         *
         ...
         */
        fun build(): SingleCustomChartResponseBase =
            SingleCustomChartResponseBase(
    ...
    fun validate(): SingleCustomChartResponseBase = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SingleCustomChartResponseBase &&
            data == other.data &&
    ...
    override fun toString() =
        "SingleCustomChartResponseBase{data=$data, additionalProperties=$additionalProperties}"
}
