...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BoxRetrieveResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BoxRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(boxRetrieveResponse: BoxRetrieveResponse) = apply {
            id = boxRetrieveResponse.id
            createdAt = boxRetrieveResponse.createdAt
            createdBy = boxRetrieveResponse.createdBy
            dataplaneUrl = boxRetrieveResponse.dataplaneUrl
            deleteAfterStopSeconds = boxRetrieveResponse.deleteAfterStopSeconds
            fsCapacityBytes = boxRetrieveResponse.fsCapacityBytes
            idleTtlSeconds = boxRetrieveResponse.idleTtlSeconds
            memBytes = boxRetrieveResponse.memBytes
            mounts = boxRetrieveResponse.mounts.map { it.toMutableList() }
            name = boxRetrieveResponse.name
            proxyConfig = boxRetrieveResponse.proxyConfig
            sizeClass = boxRetrieveResponse.sizeClass
            snapshotId = boxRetrieveResponse.snapshotId
            status = boxRetrieveResponse.status
            statusMessage = boxRetrieveResponse.statusMessage
            stoppedAt = boxRetrieveResponse.stoppedAt
            updatedAt = boxRetrieveResponse.updatedAt
            updatedBy = boxRetrieveResponse.updatedBy
            vcpus = boxRetrieveResponse.vcpus
            additionalProperties = boxRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BoxRetrieveResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BoxRetrieveResponse =
            BoxRetrieveResponse(
                id,
                createdAt,
                createdBy,
     ...
     *   expected type.
     */
    fun validate(): BoxRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        override fun hashCode(): Int =
            Objects.hash(sandboxapiS3BucketMountSpec, sandboxapiGcsBucketMountSpec)
                ...
                val bestMatches =
                    sequenceOf(
                            ...
                            tryDeserialize(node, jacksonTypeRef<SandboxapiGcsBucketMountSpec>())
                                ?.let { Mount(sandboxapiGcsBucketMountSpec = it, _json = json) },
                        )
                        .filterNotNull()
        ...
        private constructor(
            ...
            ) : this(id, mountPath, s3, type, cache, gcs, readOnly, mutableMapOf())
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.gcs] with a well-typed [Gcs] value instead. This
                 * method is primarily for setting the field to an undocumented or not yet supported
                 * value.
                 */
            ...
            private val hashCode: Int by lazy {
                Objects.hash(id, mountPath, s3, type, cache, gcs, readOnly, additionalProperties)
            }

            override fun hashCode(): Int = hashCode

            override fun toString() =
                "SandboxapiS3BucketMountSpec{id=$id, mountPath=$mountPath, s3=$s3, type=$type, cache=$cache, gcs=$gcs, readOnly=$readOnly, additionalProperties=$additionalProperties}"
        }
        ...
        private constructor(
            ...
            private constructor(
                ...
                readOnly: JsonField<Boolean> = JsonMissing.of(),
                @JsonProperty("s3") @ExcludeMissing s3: JsonField<S3> = JsonMissing.of(),
            ) : this(id, gcs, mountPath, type, cache, readOnly, s3, mutableMapOf())
            ...
            private val hashCode: Int by lazy {
                Objects.hash(id, gcs, mountPath, type, cache, readOnly, s3, additionalProperties)
            }

            override fun hashCode(): Int = hashCode

            override fun toString() =
                "SandboxapiGcsBucketMountSpec{id=$id, gcs=$gcs, mountPath=$mountPath, type=$type, cache=$cache, readOnly=$readOnly, s3=$s3, additionalProperties=$additionalProperties}"
        }
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BoxRetrieveResponse &&
            id == other.id &&
