...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrgMemberIdentity].
         *
    ...
    /** A builder for [OrgMemberIdentity]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orgMemberIdentity: OrgMemberIdentity) = apply {
            id = orgMemberIdentity.id
            createdAt = orgMemberIdentity.createdAt
            lsUserId = orgMemberIdentity.lsUserId
            organizationId = orgMemberIdentity.organizationId
            readOnly = orgMemberIdentity.readOnly
            userId = orgMemberIdentity.userId
            accessScope = orgMemberIdentity.accessScope
            avatarUrl = orgMemberIdentity.avatarUrl
            displayName = orgMemberIdentity.displayName
            email = orgMemberIdentity.email
            fullName = orgMemberIdentity.fullName
            isDisabled = orgMemberIdentity.isDisabled
            linkedLoginMethods = orgMemberIdentity.linkedLoginMethods.map { it.toMutableList() }
            orgRoleId = orgMemberIdentity.orgRoleId
            orgRoleName = orgMemberIdentity.orgRoleName
            roleId = orgMemberIdentity.roleId
            roleName = orgMemberIdentity.roleName
            tenantId = orgMemberIdentity.tenantId
            tenantIds = orgMemberIdentity.tenantIds.map { it.toMutableList() }
            additionalProperties = orgMemberIdentity.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): OrgMemberIdentity = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrgMemberIdentity &&
            id == other.id &&
    ...
    override fun toString() =
        "OrgMemberIdentity{id=$id, createdAt=$createdAt, lsUserId=$lsUserId, organizationId=$organizationId, readOnly=$readOnly, userId=$userId, accessScope=$accessScope, avatarUrl=$avatarUrl, displayName=$displayName, email=$email, fullName=$fullName, isDisabled=$isDisabled, linkedLoginMethods=$linkedLoginMethods, orgRoleId=$orgRoleId, orgRoleName=$orgRoleName, roleId=$roleId, roleName=$roleName, tenantId=$tenantId, tenantIds=$tenantIds, additionalProperties=$additionalProperties}"
}
