...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FileEntry].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileEntry: FileEntry) = apply {
            content = fileEntry.content
            type = fileEntry.type
            additionalProperties = fileEntry.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FileEntry].
         *
    ...
    override fun toString() =
        "FileEntry{content=$content, type=$type, additionalProperties=$additionalProperties}"
}
