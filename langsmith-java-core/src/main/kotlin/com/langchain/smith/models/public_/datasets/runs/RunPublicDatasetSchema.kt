...
private constructor(
    ...
    /** A builder for [RunPublicDatasetSchema]. */
    class Builder internal constructor() {
        ...
        internal fun from(runPublicDatasetSchema: RunPublicDatasetSchema) = apply {
            id = runPublicDatasetSchema.id
            dottedOrder = runPublicDatasetSchema.dottedOrder
            name = runPublicDatasetSchema.name
            runType = runPublicDatasetSchema.runType
            sessionId = runPublicDatasetSchema.sessionId
            status = runPublicDatasetSchema.status
            traceId = runPublicDatasetSchema.traceId
            childRunIds = runPublicDatasetSchema.childRunIds.map { it.toMutableList() }
            completionCost = runPublicDatasetSchema.completionCost
            completionCostDetails = runPublicDatasetSchema.completionCostDetails
            completionTokenDetails = runPublicDatasetSchema.completionTokenDetails
            completionTokens = runPublicDatasetSchema.completionTokens
            directChildRunIds = runPublicDatasetSchema.directChildRunIds.map { it.toMutableList() }
            endTime = runPublicDatasetSchema.endTime
            error = runPublicDatasetSchema.error
            events = runPublicDatasetSchema.events.map { it.toMutableList() }
            executionOrder = runPublicDatasetSchema.executionOrder
            extra = runPublicDatasetSchema.extra
            feedbackStats = runPublicDatasetSchema.feedbackStats
            firstTokenTime = runPublicDatasetSchema.firstTokenTime
            inputs = runPublicDatasetSchema.inputs
            inputsPreview = runPublicDatasetSchema.inputsPreview
            inputsS3Urls = runPublicDatasetSchema.inputsS3Urls
            manifestId = runPublicDatasetSchema.manifestId
            manifestS3Id = runPublicDatasetSchema.manifestS3Id
            outputs = runPublicDatasetSchema.outputs
            outputsPreview = runPublicDatasetSchema.outputsPreview
            outputsS3Urls = runPublicDatasetSchema.outputsS3Urls
            parentRunId = runPublicDatasetSchema.parentRunId
            parentRunIds = runPublicDatasetSchema.parentRunIds.map { it.toMutableList() }
            priceModelId = runPublicDatasetSchema.priceModelId
            promptCost = runPublicDatasetSchema.promptCost
            promptCostDetails = runPublicDatasetSchema.promptCostDetails
            promptTokenDetails = runPublicDatasetSchema.promptTokenDetails
            promptTokens = runPublicDatasetSchema.promptTokens
            referenceExampleId = runPublicDatasetSchema.referenceExampleId
            s3Urls = runPublicDatasetSchema.s3Urls
            serialized = runPublicDatasetSchema.serialized
            startTime = runPublicDatasetSchema.startTime
            tags = runPublicDatasetSchema.tags.map { it.toMutableList() }
            totalCost = runPublicDatasetSchema.totalCost
            totalTokens = runPublicDatasetSchema.totalTokens
            traceMaxStartTime = runPublicDatasetSchema.traceMaxStartTime
            traceMinStartTime = runPublicDatasetSchema.traceMinStartTime
            additionalProperties = runPublicDatasetSchema.additionalProperties.toMutableMap()
        }
