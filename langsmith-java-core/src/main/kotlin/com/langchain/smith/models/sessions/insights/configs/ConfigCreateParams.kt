...
private constructor(
    ...
    private constructor(
        ...
        private val hashCode: Int by lazy {
            Objects.hash(config, name, description, scheduleCron, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{config=$config, name=$name, description=$description, scheduleCron=$scheduleCron, additionalProperties=$additionalProperties}"
    }
