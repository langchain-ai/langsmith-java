...
class AnnotationQueueRetrieveAnnotationQueuesResponse
...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("total_runs") @ExcludeMissing totalRuns: JsonField<Long> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun totalRuns(): Long = totalRuns.getRequired("total_runs")
     ...
     */
    @JsonProperty("total_runs") @ExcludeMissing fun _totalRuns(): JsonField<Long> = totalRuns
    ...
    /** A builder for [AnnotationQueueRetrieveAnnotationQueuesResponse]. */
    class Builder internal constructor() {
        ...
        private var totalRuns: JsonField<Long>? = null
        ...
        internal fun from(
            ...
            id = annotationQueueRetrieveAnnotationQueuesResponse.id
            name = annotationQueueRetrieveAnnotationQueuesResponse.name
            queueType = annotationQueueRetrieveAnnotationQueuesResponse.queueType
            tenantId = annotationQueueRetrieveAnnotationQueuesResponse.tenantId
            totalRuns = annotationQueueRetrieveAnnotationQueuesResponse.totalRuns
            assignedReviewers =
                annotationQueueRetrieveAnnotationQueuesResponse.assignedReviewers.map {
                    it.toMutableList()
                }
            createdAt = annotationQueueRetrieveAnnotationQueuesResponse.createdAt
            defaultDataset = annotationQueueRetrieveAnnotationQueuesResponse.defaultDataset
            description = annotationQueueRetrieveAnnotationQueuesResponse.description
            enableReservations = annotationQueueRetrieveAnnotationQueuesResponse.enableReservations
            metadata = annotationQueueRetrieveAnnotationQueuesResponse.metadata
            numReviewersPerItem =
                annotationQueueRetrieveAnnotationQueuesResponse.numReviewersPerItem
            reservationMinutes = annotationQueueRetrieveAnnotationQueuesResponse.reservationMinutes
            reviewerAccessMode = annotationQueueRetrieveAnnotationQueuesResponse.reviewerAccessMode
            runRuleId = annotationQueueRetrieveAnnotationQueuesResponse.runRuleId
            sourceRuleId = annotationQueueRetrieveAnnotationQueuesResponse.sourceRuleId
            updatedAt = annotationQueueRetrieveAnnotationQueuesResponse.updatedAt
            additionalProperties =
                annotationQueueRetrieveAnnotationQueuesResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.totalRuns] with a well-typed [Long] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        ...
        /**
         * Returns an immutable instance of [AnnotationQueueRetrieveAnnotationQueuesResponse].
         *
         ...
         */
        fun build(): AnnotationQueueRetrieveAnnotationQueuesResponse =
            AnnotationQueueRetrieveAnnotationQueuesResponse(
                checkRequired("id", id),
                checkRequired("name", name),
                checkRequired("queueType", queueType),
                checkRequired("tenantId", tenantId),
                checkRequired("totalRuns", totalRuns),
     ...
     *   expected type.
     */
    fun validate(): AnnotationQueueRetrieveAnnotationQueuesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AnnotationQueueRetrieveAnnotationQueuesResponse &&
            id == other.id &&
            name == other.name &&
    ...
    override fun toString() =
        "AnnotationQueueRetrieveAnnotationQueuesResponse{id=$id, name=$name, queueType=$queueType, tenantId=$tenantId, totalRuns=$totalRuns, assignedReviewers=$assignedReviewers, createdAt=$createdAt, defaultDataset=$defaultDataset, description=$description, enableReservations=$enableReservations, metadata=$metadata, numReviewersPerItem=$numReviewersPerItem, reservationMinutes=$reservationMinutes, reviewerAccessMode=$reviewerAccessMode, runRuleId=$runRuleId, sourceRuleId=$sourceRuleId, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
