...
class UpdateOnlineEvaluatorResponse
...
private constructor(
    ...
    /** A builder for [UpdateOnlineEvaluatorResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(updateOnlineEvaluatorResponse: UpdateOnlineEvaluatorResponse) = apply {
            evaluator = updateOnlineEvaluatorResponse.evaluator
            additionalProperties = updateOnlineEvaluatorResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UpdateOnlineEvaluatorResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UpdateOnlineEvaluatorResponse =
            UpdateOnlineEvaluatorResponse(evaluator, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): UpdateOnlineEvaluatorResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UpdateOnlineEvaluatorResponse &&
    ...
    override fun toString() =
        "UpdateOnlineEvaluatorResponse{evaluator=$evaluator, additionalProperties=$additionalProperties}"
}
