...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [RunIngest]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [RunIngest]. */
    class Builder internal constructor() {
        ...
        internal fun from(runIngest: RunIngest) = apply {
            ...
            events = runIngest.events.map { it.toMutableList() }
            extra = runIngest.extra
            inputAttachments = runIngest.inputAttachments
            inputs = runIngest.inputs
            name = runIngest.name
            outputAttachments = runIngest.outputAttachments
            outputs = runIngest.outputs
            parentRunId = runIngest.parentRunId
            referenceExampleId = runIngest.referenceExampleId
            runType = runIngest.runType
            serialized = runIngest.serialized
            sessionId = runIngest.sessionId
            sessionName = runIngest.sessionName
            startTime = runIngest.startTime
        ...
        /**
         * Returns an immutable instance of [RunIngest].
         *
