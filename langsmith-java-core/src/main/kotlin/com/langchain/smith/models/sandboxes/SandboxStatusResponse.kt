...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SandboxStatusResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SandboxStatusResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sandboxStatusResponse: SandboxStatusResponse) = apply {
            status = sandboxStatusResponse.status
            statusMessage = sandboxStatusResponse.statusMessage
            additionalProperties = sandboxStatusResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SandboxStatusResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SandboxStatusResponse =
            SandboxStatusResponse(status, statusMessage, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): SandboxStatusResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SandboxStatusResponse &&
            status == other.status &&
    ...
    override fun toString() =
        "SandboxStatusResponse{status=$status, statusMessage=$statusMessage, additionalProperties=$additionalProperties}"
}
