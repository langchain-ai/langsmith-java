...
private constructor(
    ...
    private val includeMessages: Boolean?,
    ...
    fun includeMessages(): Optional<Boolean> = Optional.ofNullable(includeMessages)
    ...
    companion object {
        ...
        @JvmStatic fun none(): RunRetrieveV1Params = builder().build()

        /** Returns a mutable builder for constructing an instance of [RunRetrieveV1Params]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [RunRetrieveV1Params]. */
    class Builder internal constructor() {

        private var runId: String? = null
        private var excludeS3StoredAttributes: Boolean? = null
        private var excludeSerialized: Boolean? = null
        private var includeMessages: Boolean? = null
        ...
        @JvmSynthetic
        internal fun from(runRetrieveV1Params: RunRetrieveV1Params) = apply {
            runId = runRetrieveV1Params.runId
            excludeS3StoredAttributes = runRetrieveV1Params.excludeS3StoredAttributes
            excludeSerialized = runRetrieveV1Params.excludeSerialized
            includeMessages = runRetrieveV1Params.includeMessages
            sessionId = runRetrieveV1Params.sessionId
            startTime = runRetrieveV1Params.startTime
            additionalHeaders = runRetrieveV1Params.additionalHeaders.toBuilder()
            additionalQueryParams = runRetrieveV1Params.additionalQueryParams.toBuilder()
        }
        ...
        fun includeMessages(includeMessages: Boolean?) = apply {
            this.includeMessages = includeMessages
        }

        /**
         * Alias for [Builder.includeMessages].
         *
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun includeMessages(includeMessages: Boolean) = includeMessages(includeMessages as Boolean?)

        /** Alias for calling [Builder.includeMessages] with `includeMessages.orElse(null)`. */
        fun includeMessages(includeMessages: Optional<Boolean>) =
            includeMessages(includeMessages.getOrNull())
        ...
        /**
         * Returns an immutable instance of [RunRetrieveV1Params].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RunRetrieveV1Params =
            RunRetrieveV1Params(
                runId,
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                ...
                includeMessages?.let { put("include_messages", it.toString()) }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RunRetrieveV1Params &&
            runId == other.runId &&
    ...
    override fun toString() =
        "RunRetrieveV1Params{runId=$runId, excludeS3StoredAttributes=$excludeS3StoredAttributes, excludeSerialized=$excludeSerialized, includeMessages=$includeMessages, sessionId=$sessionId, startTime=$startTime, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
