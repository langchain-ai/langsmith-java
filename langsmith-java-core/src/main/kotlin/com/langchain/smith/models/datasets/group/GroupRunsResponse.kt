...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
             ...
             * import java.util.Optional;
             *
             * Optional<String> result = groupKey.accept(new GroupKey.Visitor<Optional<String>>() {
             *     @Override
        ...
        private constructor(
             ...
             *
             * Unlike [experimentProgress], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("experiment_progress")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                ...
                internal fun from(session: Session) = apply {
                    ...
                    experimentProgress = session.experimentProgress
                    extra = session.extra
                ...
                /**
                 * Alias for calling [Builder.experimentProgress] with
                 * `experimentProgress.orElse(null)`.
                 */
                 ...
                 * [ExperimentProgress] value instead. This method is primarily for setting the
                 * field to an undocumented or not yet supported value.
                 */
            ...
            private constructor(
                 ...
                 *
                 * Unlike [evaluatorProgress], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("evaluator_progress")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [expectedRunCount], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("expected_run_count")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [runProgress], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("run_progress")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(experimentProgress: ExperimentProgress) = apply {
                        ...
                        additionalProperties =
                            experimentProgress.additionalProperties.toMutableMap()
                    }
                     ...
                     * [EvaluatorProgress] value instead. This method is primarily for setting the
                     * field to an undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.expectedRunCount] with a well-typed [Long]
                     ...
                     *
                     * You should usually call [Builder.runProgress] with a well-typed [Double]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                ...
                private constructor(
                    ...
                    class Builder internal constructor() {
                        ...
                        internal fun from(evaluatorProgress: EvaluatorProgress) = apply {
                            additionalProperties =
                                evaluatorProgress.additionalProperties.toMutableMap()
                        }
