...
class RunListParams
private constructor(
    private val sourceBulkExportId: String,
    private val additionalHeaders: Headers,
    private val additionalQueryParams: QueryParams,
) : Params {

    fun sourceBulkExportId(): String = sourceBulkExportId
    ...
    class Builder internal constructor() {
        ...
        private var sourceBulkExportId: String? = null
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        @JvmSynthetic
        internal fun from(runListParams: RunListParams) = apply {
            sourceBulkExportId = runListParams.sourceBulkExportId
        ...
        fun sourceBulkExportId(sourceBulkExportId: String) = apply {
        ...
        fun build(): RunListParams =
            RunListParams(
                checkRequired("sourceBulkExportId", sourceBulkExportId),
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                put("source_bulk_export_id", sourceBulkExportId)
    ...
    override fun hashCode(): Int =
        Objects.hash(sourceBulkExportId, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "RunListParams{sourceBulkExportId=$sourceBulkExportId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
