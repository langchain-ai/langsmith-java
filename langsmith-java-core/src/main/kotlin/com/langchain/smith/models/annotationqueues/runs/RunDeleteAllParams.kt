...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RunDeleteAllParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [RunDeleteAllParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [RunDeleteAllParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(runDeleteAllParams: RunDeleteAllParams) = apply {
            queueId = runDeleteAllParams.queueId
            body = runDeleteAllParams.body.toBuilder()
            additionalHeaders = runDeleteAllParams.additionalHeaders.toBuilder()
            additionalQueryParams = runDeleteAllParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [RunDeleteAllParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RunDeleteAllParams =
            RunDeleteAllParams(
                queueId,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RunDeleteAllParams &&
    ...
    override fun toString() =
        "RunDeleteAllParams{queueId=$queueId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
