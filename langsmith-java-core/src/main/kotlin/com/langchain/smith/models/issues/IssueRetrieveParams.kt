...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): IssueRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [IssueRetrieveParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [IssueRetrieveParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [IssueRetrieveParams].
         *
