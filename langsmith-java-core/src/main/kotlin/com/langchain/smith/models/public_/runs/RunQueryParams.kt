...
private constructor(
    ...
    private constructor(
         ...
         */
        @JvmSynthetic internal fun validity(): Int = (id.asKnown().getOrNull()?.size ?: 0)
    ...
    override fun hashCode(): Int =
        Objects.hash(shareToken, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "RunQueryParams{shareToken=$shareToken, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
