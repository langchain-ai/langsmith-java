...
private constructor(
    ...
    private constructor(
         ...
         *     @Override
         *     public Optional<String> visitFeedbackIngestTokenCreateSchema(FeedbackIngestTokenCreateSchema feedbackIngestTokenCreateSchema) {
         *         return Optional.of(feedbackIngestTokenCreateSchema.toString());
         *     }
         *
         *     // ...
         *
