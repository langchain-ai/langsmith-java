...
private constructor(
    ...
    private val pending: JsonField<List<Pending>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        pending: JsonField<List<Pending>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun pending(): List<Pending> = pending.getRequired("pending")
     ...
     */
    @JsonProperty("pending") @ExcludeMissing fun _pending(): JsonField<List<Pending>> = pending
    ...
    class Builder internal constructor() {
        ...
        private var pending: JsonField<MutableList<Pending>>? = null
        ...
        fun pending(pending: List<Pending>) = pending(JsonField.of(pending))

        /**
         * Sets [Builder.pending] to an arbitrary JSON value.
         *
         * You should usually call [Builder.pending] with a well-typed `List<Pending>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun pending(pending: JsonField<List<Pending>>) = apply {
            this.pending = pending.map { it.toMutableList() }
        }

        /**
         * Adds a single [Pending] to [Builder.pending].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addPending(pending: Pending) = apply {
            this.pending =
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(pending: Pending) = apply {
                ...
                email = pending.email
                accessScope = pending.accessScope
                fullName = pending.fullName
                orgRoleId = pending.orgRoleId
                orgRoleName = pending.orgRoleName
                ...
                workspaceIds = pending.workspaceIds.map { it.toMutableList() }
                workspaceRoleId = pending.workspaceRoleId
             ...
             *
             * You should usually call [Builder.orgRoleName] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun orgRoleName(orgRoleName: JsonField<String>) = apply {
        ...
        class AccessScope @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            enum class Value {
                ...
                WORKSPACE,
                /**
                 * An enum member indicating that [AccessScope] was instantiated with an unknown
                 * value.
                 */
                _UNKNOWN,
            }
