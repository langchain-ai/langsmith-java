...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SnapshotRetrieveResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SnapshotRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(snapshotRetrieveResponse: SnapshotRetrieveResponse) = apply {
            id = snapshotRetrieveResponse.id
            createdAt = snapshotRetrieveResponse.createdAt
            createdBy = snapshotRetrieveResponse.createdBy
            dockerImage = snapshotRetrieveResponse.dockerImage
            ...
            status = snapshotRetrieveResponse.status
            statusMessage = snapshotRetrieveResponse.statusMessage
            updatedAt = snapshotRetrieveResponse.updatedAt
            additionalProperties = snapshotRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SnapshotRetrieveResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SnapshotRetrieveResponse =
     ...
     *   expected type.
     */
    fun validate(): SnapshotRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SnapshotRetrieveResponse &&
            id == other.id &&
