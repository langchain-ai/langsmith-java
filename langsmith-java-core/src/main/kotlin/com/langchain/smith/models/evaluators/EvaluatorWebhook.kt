...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EvaluatorWebhook].
         *
    ...
    /** A builder for [EvaluatorWebhook]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(evaluatorWebhook: EvaluatorWebhook) = apply {
            url = evaluatorWebhook.url
            headers = evaluatorWebhook.headers
            additionalProperties = evaluatorWebhook.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EvaluatorWebhook].
         *
     ...
     *   expected type.
     */
    fun validate(): EvaluatorWebhook = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EvaluatorWebhook &&
            url == other.url &&
    ...
    override fun toString() =
        "EvaluatorWebhook{url=$url, headers=$headers, additionalProperties=$additionalProperties}"
}
