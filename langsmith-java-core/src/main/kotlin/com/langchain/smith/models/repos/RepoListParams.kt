    ...
    class SortDirection @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        fun known(): Known =
            when (this) {
                ASC -> Known.ASC
                DESC -> Known.DESC
                else -> throw LangChainInvalidDataException("Unknown SortDirection: $value")
            }
    ...
    class SortField @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        fun known(): Known =
            when (this) {
                ...
                else -> throw LangChainInvalidDataException("Unknown SortField: $value")
            }
