...
import com.langchain.smith.core.immutableEmptyMap
...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CurrentCreateParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CurrentCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(currentCreateParams: CurrentCreateParams) = apply {
            apiKeyCreateRequest = currentCreateParams.apiKeyCreateRequest
            additionalHeaders = currentCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = currentCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CurrentCreateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CurrentCreateParams =
            CurrentCreateParams(
                apiKeyCreateRequest,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CurrentCreateParams &&
    ...
    override fun toString() =
        "CurrentCreateParams{apiKeyCreateRequest=$apiKeyCreateRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
