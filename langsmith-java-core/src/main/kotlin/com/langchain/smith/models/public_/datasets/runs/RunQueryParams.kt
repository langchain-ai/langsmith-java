...
private constructor(
    ...
    private val bodyParamsForRunSchema: BodyParamsForRunSchema,
    ...
    fun bodyParamsForRunSchema(): BodyParamsForRunSchema = bodyParamsForRunSchema

    fun _additionalBodyProperties(): Map<String, JsonValue> =
        bodyParamsForRunSchema._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        private var bodyParamsForRunSchema: BodyParamsForRunSchema? = null
        ...
        internal fun from(runQueryParams: RunQueryParams) = apply {
            ...
            bodyParamsForRunSchema = runQueryParams.bodyParamsForRunSchema
        ...
        /** Query params for run endpoints. */
        fun bodyParamsForRunSchema(bodyParamsForRunSchema: BodyParamsForRunSchema) = apply {
            this.bodyParamsForRunSchema = bodyParamsForRunSchema
        }
        ...
        fun build(): RunQueryParams =
            RunQueryParams(
                shareToken,
                checkRequired("bodyParamsForRunSchema", bodyParamsForRunSchema),
                additionalHeaders.build(),
                additionalQueryParams.build(),
            )
    }

    fun _body(): BodyParamsForRunSchema = bodyParamsForRunSchema
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RunQueryParams &&
            ...
            bodyParamsForRunSchema == other.bodyParamsForRunSchema &&
            additionalHeaders == other.additionalHeaders &&
            additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int =
        Objects.hash(shareToken, bodyParamsForRunSchema, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "RunQueryParams{shareToken=$shareToken, bodyParamsForRunSchema=$bodyParamsForRunSchema, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
