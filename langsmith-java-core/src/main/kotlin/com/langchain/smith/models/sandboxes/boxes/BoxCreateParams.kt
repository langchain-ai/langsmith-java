...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun mounts(): Optional<List<Mount>> = body.mounts()
     ...
     */
    fun _mounts(): JsonField<List<Mount>> = body._mounts()
    ...
    class Builder internal constructor() {
        ...
        fun mounts(mounts: List<Mount>) = apply { body.mounts(mounts) }
         ...
         * value.
         */
        fun mounts(mounts: JsonField<List<Mount>>) = apply { body.mounts(mounts) }
         ...
         */
        fun addMount(mount: Mount) = apply { body.addMount(mount) }

        /**
         * Alias for calling [addMount] with
         * `Mount.ofSandboxapiS3BucketMountSpec(sandboxapiS3BucketMountSpec)`.
         */
        fun addMount(sandboxapiS3BucketMountSpec: Mount.SandboxapiS3BucketMountSpec) = apply {
            body.addMount(sandboxapiS3BucketMountSpec)
        }
         ...
         */
        fun addMount(sandboxapiGcsBucketMountSpec: Mount.SandboxapiGcsBucketMountSpec) = apply {
            body.addMount(sandboxapiGcsBucketMountSpec)
        }
         ...
         */
        fun addMount(sandboxapiGitRepoMountSpec: Mount.SandboxapiGitRepoMountSpec) = apply {
            body.addMount(sandboxapiGitRepoMountSpec)
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) = apply {
                ...
                mounts = body.mounts.map { it.toMutableList() }
                name = body.name
        ...
        override fun toString() =
            "Body{deleteAfterStopSeconds=$deleteAfterStopSeconds, envVars=$envVars, fsCapacityBytes=$fsCapacityBytes, idleTtlSeconds=$idleTtlSeconds, memBytes=$memBytes, mounts=$mounts, name=$name, proxyConfig=$proxyConfig, restoreMemory=$restoreMemory, snapshotId=$snapshotId, snapshotName=$snapshotName, tagValueIds=$tagValueIds, vcpus=$vcpus, additionalProperties=$additionalProperties}"
    }
