...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [RunIngestBatchParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [RunIngestBatchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(runIngestBatchParams: RunIngestBatchParams) = apply {
            body = runIngestBatchParams.body.toBuilder()
            additionalHeaders = runIngestBatchParams.additionalHeaders.toBuilder()
            additionalQueryParams = runIngestBatchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [RunIngestBatchParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RunIngestBatchParams =
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) = apply {
                ...
                post = body.post.map { it.toMutableList() }
            ...
            fun build(): Body =
                Body(
                    (patch ?: JsonMissing.of()).map { it.toImmutable() },
                    (post ?: JsonMissing.of()).map { it.toImmutable() },
        ...
        fun validate(): Body = apply {
            ...
            patch().ifPresent { it.forEach { it.validate() } }
        ...
        internal fun validity(): Int =
            (patch.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
                (post.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0)
        ...
        private val hashCode: Int by lazy { Objects.hash(patch, post, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{patch=$patch, post=$post, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RunIngestBatchParams &&
            body == other.body &&
    ...
    override fun toString() =
        "RunIngestBatchParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
