...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(secretCreateParams: SecretCreateParams) = apply {
            body = secretCreateParams.body.toMutableList()
            additionalHeaders = secretCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = secretCreateParams.additionalQueryParams.toBuilder()
        }
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{key=$key, value=$value, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SecretCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "SecretCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
