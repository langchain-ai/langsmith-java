...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(pendingListResponse: PendingListResponse) = apply {
            ...
            displayName = pendingListResponse.displayName
            isDeleted = pendingListResponse.isDeleted
            isPersonal = pendingListResponse.isPersonal
            organizationId = pendingListResponse.organizationId
            tenantHandle = pendingListResponse.tenantHandle
    ...
    override fun toString() =
        "PendingListResponse{id=$id, createdAt=$createdAt, displayName=$displayName, isDeleted=$isDeleted, isPersonal=$isPersonal, organizationId=$organizationId, tenantHandle=$tenantHandle, additionalProperties=$additionalProperties}"
}
