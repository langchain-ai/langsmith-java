...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PendingListResponse].
         *
    ...
    /** A builder for [PendingListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pendingListResponse: PendingListResponse) = apply {
            id = pendingListResponse.id
            createdAt = pendingListResponse.createdAt
            email = pendingListResponse.email
            accessScope = pendingListResponse.accessScope
            fullName = pendingListResponse.fullName
            orgRoleId = pendingListResponse.orgRoleId
            orgRoleName = pendingListResponse.orgRoleName
            organizationId = pendingListResponse.organizationId
            password = pendingListResponse.password
            readOnly = pendingListResponse.readOnly
            roleId = pendingListResponse.roleId
            roleName = pendingListResponse.roleName
            tenantId = pendingListResponse.tenantId
            userId = pendingListResponse.userId
            workspaceIds = pendingListResponse.workspaceIds.map { it.toMutableList() }
            workspaceRoleId = pendingListResponse.workspaceRoleId
            additionalProperties = pendingListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PendingListResponse].
         *
    ...
    fun validate(): PendingListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PendingListResponse &&
            id == other.id &&
