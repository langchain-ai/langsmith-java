...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FeedbackCreateSchema].
         *
    ...
    /** A builder for [FeedbackCreateSchema]. */
    class Builder internal constructor() {
        ...
        internal fun from(feedbackCreateSchema: FeedbackCreateSchema) = apply {
            ...
            doNotExtendTraceRetention = feedbackCreateSchema.doNotExtendTraceRetention
        ...
        /**
         * Returns an immutable instance of [FeedbackCreateSchema].
         *
         ...
         */
        fun build(): FeedbackCreateSchema =
     ...
     *   expected type.
     */
    fun validate(): FeedbackCreateSchema = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = correction.accept(new Correction.Visitor<Optional<String>>() {
         *     @Override
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = feedbackSource.accept(new FeedbackSource.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitApp(AppFeedbackSource app) {
         *         return Optional.of(app.toString());
         *     }
         *
         *     // ...
         *
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = score.accept(new Score.Visitor<Optional<String>>() {
         *     @Override
