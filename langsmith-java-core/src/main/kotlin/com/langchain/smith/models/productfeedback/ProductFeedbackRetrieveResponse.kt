...
class ProductFeedbackRetrieveResponse
...
private constructor(
    ...
    /** A builder for [ProductFeedbackRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(productFeedbackRetrieveResponse: ProductFeedbackRetrieveResponse) =
            apply {
                id = productFeedbackRetrieveResponse.id
                category = productFeedbackRetrieveResponse.category
                createdAt = productFeedbackRetrieveResponse.createdAt
                message = productFeedbackRetrieveResponse.message
                source = productFeedbackRetrieveResponse.source
                client = productFeedbackRetrieveResponse.client
                additionalProperties =
                    productFeedbackRetrieveResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ProductFeedbackRetrieveResponse].
         *
         ...
         */
        fun build(): ProductFeedbackRetrieveResponse =
            ProductFeedbackRetrieveResponse(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): ProductFeedbackRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProductFeedbackRetrieveResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "ProductFeedbackRetrieveResponse{id=$id, category=$category, createdAt=$createdAt, message=$message, source=$source, client=$client, additionalProperties=$additionalProperties}"
}
