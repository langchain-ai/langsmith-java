 ...
 */
class ProductFeedbackCreateParams
private constructor(
     ...
     */
    fun client(): Optional<Client> = body.client()
     ...
     */
    fun _client(): JsonField<Client> = body._client()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProductFeedbackCreateParams].
         *
    ...
    /** A builder for [ProductFeedbackCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(productFeedbackCreateParams: ProductFeedbackCreateParams) = apply {
            idempotencyKey = productFeedbackCreateParams.idempotencyKey
            body = productFeedbackCreateParams.body.toBuilder()
            additionalHeaders = productFeedbackCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = productFeedbackCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        fun client(client: Client) = apply { body.client(client) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun client(client: JsonField<Client>) = apply { body.client(client) }
        ...
        /**
         * Returns an immutable instance of [ProductFeedbackCreateParams].
         *
         ...
         */
        fun build(): ProductFeedbackCreateParams =
    ...
    private constructor(
        ...
        ) : this(category, message, source, client, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             * Sets [Builder.client] to an arbitrary JSON value.
             *
             * You should usually call [Builder.client] with a well-typed [Client] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        private val hashCode: Int by lazy {
            Objects.hash(category, message, source, client, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{category=$category, message=$message, source=$source, client=$client, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProductFeedbackCreateParams &&
    ...
    override fun toString() =
        "ProductFeedbackCreateParams{idempotencyKey=$idempotencyKey, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
