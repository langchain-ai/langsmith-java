...
class DatasetRetrieveOpenAIParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DatasetRetrieveOpenAIParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DatasetRetrieveOpenAIParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(datasetRetrieveOpenAIParams: DatasetRetrieveOpenAIParams) = apply {
            datasetId = datasetRetrieveOpenAIParams.datasetId
            asOf = datasetRetrieveOpenAIParams.asOf
            additionalHeaders = datasetRetrieveOpenAIParams.additionalHeaders.toBuilder()
            additionalQueryParams = datasetRetrieveOpenAIParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DatasetRetrieveOpenAIParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DatasetRetrieveOpenAIParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DatasetRetrieveOpenAIParams &&
    ...
    override fun toString() =
        "DatasetRetrieveOpenAIParams{datasetId=$datasetId, asOf=$asOf, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
