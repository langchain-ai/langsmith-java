...
private constructor(
    ...
    private constructor(
        ...
        ) : this(sessionId, traceId, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(sessionId, traceId, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy { Objects.hash(sessionId, traceId, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{sessionId=$sessionId, traceId=$traceId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun hashCode(): Int =
        Objects.hash(runId, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ShareCreateParams{runId=$runId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
