...
private constructor(
    ...
    /** A builder for [AnnotationQueueRetrieveRunParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(annotationQueueRetrieveRunParams: AnnotationQueueRetrieveRunParams) =
            apply {
                queueId = annotationQueueRetrieveRunParams.queueId
                index = annotationQueueRetrieveRunParams.index
                includeExtra = annotationQueueRetrieveRunParams.includeExtra
                additionalHeaders = annotationQueueRetrieveRunParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    annotationQueueRetrieveRunParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AnnotationQueueRetrieveRunParams].
         *
         ...
         */
        fun build(): AnnotationQueueRetrieveRunParams =
            AnnotationQueueRetrieveRunParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AnnotationQueueRetrieveRunParams &&
    ...
    override fun toString() =
        "AnnotationQueueRetrieveRunParams{queueId=$queueId, index=$index, includeExtra=$includeExtra, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
