...
private constructor(
    ...
    private val isTracingDisabled: JsonField<Boolean>,
    ...
    private constructor(
        ...
        @JsonProperty("is_tracing_disabled")
        @ExcludeMissing
        isTracingDisabled: JsonField<Boolean> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun isTracingDisabled(): Optional<Boolean> =
        isTracingDisabled.getOptional("is_tracing_disabled")
    ...
    @JsonProperty("extend_evaluator_trace_retention")
    @ExcludeMissing
    fun _extendEvaluatorTraceRetention(): JsonField<Boolean> = extendEvaluatorTraceRetention
    ...
    /**
     * Returns the raw JSON value of [isTracingDisabled].
     *
     * Unlike [isTracingDisabled], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("is_tracing_disabled")
    @ExcludeMissing
    fun _isTracingDisabled(): JsonField<Boolean> = isTracingDisabled
    ...
    class Builder internal constructor() {
        ...
        private var isTracingDisabled: JsonField<Boolean> = JsonMissing.of()
        ...
        internal fun from(evaluator: Evaluator) = apply {
            ...
            isTracingDisabled = evaluator.isTracingDisabled
        ...
        /**
         * Alias for [Builder.extendEvaluatorTraceRetention].
         *
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun extendEvaluatorTraceRetention(extendEvaluatorTraceRetention: Boolean) =
            extendEvaluatorTraceRetention(extendEvaluatorTraceRetention as Boolean?)

        /**
         * Alias for calling [Builder.extendEvaluatorTraceRetention] with
         * `extendEvaluatorTraceRetention.orElse(null)`.
         */
        fun extendEvaluatorTraceRetention(extendEvaluatorTraceRetention: Optional<Boolean>) =
            extendEvaluatorTraceRetention(extendEvaluatorTraceRetention.getOrNull())

        /**
         * Sets [Builder.extendEvaluatorTraceRetention] to an arbitrary JSON value.
         *
         * You should usually call [Builder.extendEvaluatorTraceRetention] with a well-typed
         * [Boolean] value instead. This method is primarily for setting the field to an
         * undocumented or not yet supported value.
         */
        fun extendEvaluatorTraceRetention(extendEvaluatorTraceRetention: JsonField<Boolean>) =
            apply {
        ...
        fun isTracingDisabled(isTracingDisabled: Boolean) =
            isTracingDisabled(JsonField.of(isTracingDisabled))

        /**
         * Sets [Builder.isTracingDisabled] to an arbitrary JSON value.
         *
         * You should usually call [Builder.isTracingDisabled] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun isTracingDisabled(isTracingDisabled: JsonField<Boolean>) = apply {
        ...
        fun spendUsd(spendUsd: Double?) = spendUsd(JsonField.ofNullable(spendUsd))

        /**
         * Alias for [Builder.spendUsd].
         *
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun spendUsd(spendUsd: Double) = spendUsd(spendUsd as Double?)

        /** Alias for calling [Builder.spendUsd] with `spendUsd.orElse(null)`. */
        fun spendUsd(spendUsd: Optional<Double>) = spendUsd(spendUsd.getOrNull())
        ...
        fun traceCount(traceCount: Long?) = traceCount(JsonField.ofNullable(traceCount))

        /**
         * Alias for [Builder.traceCount].
         *
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun traceCount(traceCount: Long) = traceCount(traceCount as Long?)

        /** Alias for calling [Builder.traceCount] with `traceCount.orElse(null)`. */
        fun traceCount(traceCount: Optional<Long>) = traceCount(traceCount.getOrNull())
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (if (isTracingDisabled.asKnown().isPresent) 1 else 0) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is Evaluator &&
            ...
            isTracingDisabled == other.isTracingDisabled &&
