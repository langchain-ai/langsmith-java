...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [PoolUpdateResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PoolUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(poolUpdateResponse: PoolUpdateResponse) = apply {
            id = poolUpdateResponse.id
            createdAt = poolUpdateResponse.createdAt
            name = poolUpdateResponse.name
            replicas = poolUpdateResponse.replicas
            templateName = poolUpdateResponse.templateName
            updatedAt = poolUpdateResponse.updatedAt
            additionalProperties = poolUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PoolUpdateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PoolUpdateResponse =
            PoolUpdateResponse(
                id,
                createdAt,
                name,
    ...
    fun validate(): PoolUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PoolUpdateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "PoolUpdateResponse{id=$id, createdAt=$createdAt, name=$name, replicas=$replicas, templateName=$templateName, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
