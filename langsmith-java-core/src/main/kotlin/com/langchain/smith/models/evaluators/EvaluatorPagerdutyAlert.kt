...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EvaluatorPagerdutyAlert].
         *
    ...
    /** A builder for [EvaluatorPagerdutyAlert]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(evaluatorPagerdutyAlert: EvaluatorPagerdutyAlert) = apply {
            routingKey = evaluatorPagerdutyAlert.routingKey
            severity = evaluatorPagerdutyAlert.severity
            summary = evaluatorPagerdutyAlert.summary
            type = evaluatorPagerdutyAlert.type
            additionalProperties = evaluatorPagerdutyAlert.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EvaluatorPagerdutyAlert].
         *
         ...
         */
        fun build(): EvaluatorPagerdutyAlert =
     ...
     *   expected type.
     */
    fun validate(): EvaluatorPagerdutyAlert = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EvaluatorPagerdutyAlert &&
    ...
    override fun toString() =
        "EvaluatorPagerdutyAlert{routingKey=$routingKey, severity=$severity, summary=$summary, type=$type, additionalProperties=$additionalProperties}"
}
