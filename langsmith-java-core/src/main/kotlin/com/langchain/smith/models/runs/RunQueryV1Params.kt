...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): RunQueryV1Params = builder().build()

        /** Returns a mutable builder for constructing an instance of [RunQueryV1Params]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [RunQueryV1Params]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(runQueryV1Params: RunQueryV1Params) = apply {
            body = runQueryV1Params.body.toBuilder()
            additionalHeaders = runQueryV1Params.additionalHeaders.toBuilder()
            additionalQueryParams = runQueryV1Params.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [RunQueryV1Params].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RunQueryV1Params =
            RunQueryV1Params(body.build(), additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RunQueryV1Params &&
            body == other.body &&
    ...
    override fun toString() =
        "RunQueryV1Params{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
