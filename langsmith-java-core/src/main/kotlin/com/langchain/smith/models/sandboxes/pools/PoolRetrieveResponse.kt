...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [PoolRetrieveResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PoolRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(poolRetrieveResponse: PoolRetrieveResponse) = apply {
            id = poolRetrieveResponse.id
            createdAt = poolRetrieveResponse.createdAt
            name = poolRetrieveResponse.name
            replicas = poolRetrieveResponse.replicas
            templateName = poolRetrieveResponse.templateName
            updatedAt = poolRetrieveResponse.updatedAt
            additionalProperties = poolRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PoolRetrieveResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PoolRetrieveResponse =
    ...
    fun validate(): PoolRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PoolRetrieveResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "PoolRetrieveResponse{id=$id, createdAt=$createdAt, name=$name, replicas=$replicas, templateName=$templateName, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
