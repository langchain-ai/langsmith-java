...
private constructor(
    ...
    private constructor(
        ...
        ) : this(name, password, url, username, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(name, password, url, username, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{name=$name, password=$password, url=$url, username=$username, additionalProperties=$additionalProperties}"
    }
