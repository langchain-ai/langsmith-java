...
private constructor(
        ...
        internal fun from(createOnlineCodeEvaluatorRequest: CreateOnlineCodeEvaluatorRequest) =
            apply {
                ...
                workspaceSecretsKeys =
                    createOnlineCodeEvaluatorRequest.workspaceSecretsKeys.map { it.toMutableList() }
    ...
    override fun toString() =
        "CreateOnlineCodeEvaluatorRequest{code=$code, dependencies=$dependencies, language=$language, workspaceSecretsKeys=$workspaceSecretsKeys, additionalProperties=$additionalProperties}"
}
