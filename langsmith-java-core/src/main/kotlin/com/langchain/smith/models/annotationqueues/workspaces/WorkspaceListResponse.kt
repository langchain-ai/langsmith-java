...
private constructor(
     ...
     */
    fun dataPlaneUrl(): Optional<String> = dataPlaneUrl.getOptional("data_plane_url")
     ...
     *   server responded with an unexpected value).
     */
    @Deprecated("deprecated") fun readOnly(): Optional<Boolean> = readOnly.getOptional("read_only")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [WorkspaceListResponse].
         *
    ...
    /** A builder for [WorkspaceListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(workspaceListResponse: WorkspaceListResponse) = apply {
            id = workspaceListResponse.id
            createdAt = workspaceListResponse.createdAt
            displayName = workspaceListResponse.displayName
            isDeleted = workspaceListResponse.isDeleted
            isPersonal = workspaceListResponse.isPersonal
            dataPlaneUrl = workspaceListResponse.dataPlaneUrl
            organizationId = workspaceListResponse.organizationId
            permissions = workspaceListResponse.permissions.map { it.toMutableList() }
            readOnly = workspaceListResponse.readOnly
            roleId = workspaceListResponse.roleId
            roleName = workspaceListResponse.roleName
            tenantHandle = workspaceListResponse.tenantHandle
            additionalProperties = workspaceListResponse.additionalProperties.toMutableMap()
        }
        ...
        fun dataPlaneUrl(dataPlaneUrl: String?) = dataPlaneUrl(JsonField.ofNullable(dataPlaneUrl))

        /** Alias for calling [Builder.dataPlaneUrl] with `dataPlaneUrl.orElse(null)`. */
        fun dataPlaneUrl(dataPlaneUrl: Optional<String>) = dataPlaneUrl(dataPlaneUrl.getOrNull())
        ...
        @Deprecated("deprecated") fun readOnly(readOnly: Boolean) = readOnly(JsonField.of(readOnly))
        ...
        /**
         * Returns an immutable instance of [WorkspaceListResponse].
         *
         ...
         */
        fun build(): WorkspaceListResponse =
    ...
    fun validate(): WorkspaceListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WorkspaceListResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "WorkspaceListResponse{id=$id, createdAt=$createdAt, displayName=$displayName, isDeleted=$isDeleted, isPersonal=$isPersonal, dataPlaneUrl=$dataPlaneUrl, organizationId=$organizationId, permissions=$permissions, readOnly=$readOnly, roleId=$roleId, roleName=$roleName, tenantHandle=$tenantHandle, additionalProperties=$additionalProperties}"
}
