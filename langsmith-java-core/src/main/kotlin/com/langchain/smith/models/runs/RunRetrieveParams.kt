...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(runRetrieveParams: RunRetrieveParams) = apply {
            ...
            includeMessages = runRetrieveParams.includeMessages
    ...
    override fun toString() =
        "RunRetrieveParams{runId=$runId, excludeS3StoredAttributes=$excludeS3StoredAttributes, excludeSerialized=$excludeSerialized, includeMessages=$includeMessages, sessionId=$sessionId, startTime=$startTime, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
