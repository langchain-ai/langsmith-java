...
class AnnotationQueueRetrieveResponse
...
private constructor(
    ...
    /** A builder for [AnnotationQueueRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(annotationQueueRetrieveResponse: AnnotationQueueRetrieveResponse) =
            apply {
                ...
                sourceRuleId = annotationQueueRetrieveResponse.sourceRuleId
                updatedAt = annotationQueueRetrieveResponse.updatedAt
                additionalProperties =
                    annotationQueueRetrieveResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AnnotationQueueRetrieveResponse].
         *
         ...
         */
        fun build(): AnnotationQueueRetrieveResponse =
            AnnotationQueueRetrieveResponse(
                checkRequired("id", id),
    ...
    fun validate(): AnnotationQueueRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
