...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(workspaceRetrieveResponse: WorkspaceRetrieveResponse) = apply {
            ...
            createdAt = workspaceRetrieveResponse.createdAt
            displayName = workspaceRetrieveResponse.displayName
            isDeleted = workspaceRetrieveResponse.isDeleted
            isPersonal = workspaceRetrieveResponse.isPersonal
            dataPlaneUrl = workspaceRetrieveResponse.dataPlaneUrl
            organizationId = workspaceRetrieveResponse.organizationId
            permissions = workspaceRetrieveResponse.permissions.map { it.toMutableList() }
            readOnly = workspaceRetrieveResponse.readOnly
            roleId = workspaceRetrieveResponse.roleId
            roleName = workspaceRetrieveResponse.roleName
            tenantHandle = workspaceRetrieveResponse.tenantHandle
