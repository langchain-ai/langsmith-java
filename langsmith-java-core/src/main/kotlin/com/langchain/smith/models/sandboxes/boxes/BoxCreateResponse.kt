...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BoxCreateResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BoxCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(boxCreateResponse: BoxCreateResponse) = apply {
            id = boxCreateResponse.id
            createdAt = boxCreateResponse.createdAt
            createdBy = boxCreateResponse.createdBy
            dataplaneUrl = boxCreateResponse.dataplaneUrl
            deleteAfterStopSeconds = boxCreateResponse.deleteAfterStopSeconds
            fsCapacityBytes = boxCreateResponse.fsCapacityBytes
            idleTtlSeconds = boxCreateResponse.idleTtlSeconds
            memBytes = boxCreateResponse.memBytes
            mounts = boxCreateResponse.mounts.map { it.toMutableList() }
            name = boxCreateResponse.name
            proxyConfig = boxCreateResponse.proxyConfig
            sizeClass = boxCreateResponse.sizeClass
            snapshotId = boxCreateResponse.snapshotId
            status = boxCreateResponse.status
            statusMessage = boxCreateResponse.statusMessage
            stoppedAt = boxCreateResponse.stoppedAt
            updatedAt = boxCreateResponse.updatedAt
            updatedBy = boxCreateResponse.updatedBy
            vcpus = boxCreateResponse.vcpus
            additionalProperties = boxCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BoxCreateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BoxCreateResponse =
            BoxCreateResponse(
                id,
                createdAt,
                createdBy,
     ...
     *   expected type.
     */
    fun validate(): BoxCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BoxCreateResponse &&
            id == other.id &&
