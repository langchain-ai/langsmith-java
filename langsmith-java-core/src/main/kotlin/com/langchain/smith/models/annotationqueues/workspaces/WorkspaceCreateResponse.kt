...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(workspaceCreateResponse: WorkspaceCreateResponse) = apply {
            ...
            dataPlaneUrl = workspaceCreateResponse.dataPlaneUrl
    ...
    override fun toString() =
        "WorkspaceCreateResponse{id=$id, createdAt=$createdAt, displayName=$displayName, isDeleted=$isDeleted, isPersonal=$isPersonal, dataPlaneUrl=$dataPlaneUrl, organizationId=$organizationId, tenantHandle=$tenantHandle, additionalProperties=$additionalProperties}"
}
