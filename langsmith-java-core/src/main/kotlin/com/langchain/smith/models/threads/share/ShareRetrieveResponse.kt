...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(shareRetrieveResponse: ShareRetrieveResponse) = apply {
            shareToken = shareRetrieveResponse.shareToken
            additionalProperties = shareRetrieveResponse.additionalProperties.toMutableMap()
        }
     ...
     *   expected type.
     */
    fun validate(): ShareRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ShareRetrieveResponse &&
    ...
    override fun toString() =
        "ShareRetrieveResponse{shareToken=$shareToken, additionalProperties=$additionalProperties}"
}
