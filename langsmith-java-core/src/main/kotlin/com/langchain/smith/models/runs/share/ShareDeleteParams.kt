...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ShareDeleteParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ShareDeleteParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ShareDeleteParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(shareDeleteParams: ShareDeleteParams) = apply {
            traceId = shareDeleteParams.traceId
            body = shareDeleteParams.body.toBuilder()
            additionalHeaders = shareDeleteParams.additionalHeaders.toBuilder()
            additionalQueryParams = shareDeleteParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ShareDeleteParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ShareDeleteParams =
            ShareDeleteParams(
                traceId,
                body.build(),
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(sessionId, additionalProperties.toMutableMap())
        }
        ...
        override fun toString() =
            "Body{sessionId=$sessionId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ShareDeleteParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(traceId, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ShareDeleteParams{traceId=$traceId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
