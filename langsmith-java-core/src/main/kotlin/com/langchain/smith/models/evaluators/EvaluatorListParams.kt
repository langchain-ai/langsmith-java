...
/** List all run rules. */
class EvaluatorListParams
private constructor(
    private val id: List<String>?,
    private val datasetId: String?,
    private val evaluatorId: String?,
    private val includeBackfillProgress: Boolean?,
    ...
    fun includeBackfillProgress(): Optional<Boolean> = Optional.ofNullable(includeBackfillProgress)
    ...
    companion object {
        ...
        @JvmStatic fun none(): EvaluatorListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [EvaluatorListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [EvaluatorListParams]. */
    class Builder internal constructor() {

        private var id: MutableList<String>? = null
        private var datasetId: String? = null
        private var evaluatorId: String? = null
        private var includeBackfillProgress: Boolean? = null
        ...
        @JvmSynthetic
        internal fun from(evaluatorListParams: EvaluatorListParams) = apply {
            id = evaluatorListParams.id?.toMutableList()
            datasetId = evaluatorListParams.datasetId
            evaluatorId = evaluatorListParams.evaluatorId
            includeBackfillProgress = evaluatorListParams.includeBackfillProgress
            nameContains = evaluatorListParams.nameContains
            sessionId = evaluatorListParams.sessionId
            tagValueId = evaluatorListParams.tagValueId?.toMutableList()
            type = evaluatorListParams.type
            additionalHeaders = evaluatorListParams.additionalHeaders.toBuilder()
            additionalQueryParams = evaluatorListParams.additionalQueryParams.toBuilder()
        }
        ...
        fun includeBackfillProgress(includeBackfillProgress: Boolean?) = apply {
            this.includeBackfillProgress = includeBackfillProgress
        }

        /**
         * Alias for [Builder.includeBackfillProgress].
         *
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun includeBackfillProgress(includeBackfillProgress: Boolean) =
            includeBackfillProgress(includeBackfillProgress as Boolean?)

        /**
         * Alias for calling [Builder.includeBackfillProgress] with
         * `includeBackfillProgress.orElse(null)`.
         */
        fun includeBackfillProgress(includeBackfillProgress: Optional<Boolean>) =
            includeBackfillProgress(includeBackfillProgress.getOrNull())
        ...
        /**
         * Returns an immutable instance of [EvaluatorListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EvaluatorListParams =
            EvaluatorListParams(
                id?.toImmutable(),
                datasetId,
                evaluatorId,
                includeBackfillProgress,
                nameContains,
                sessionId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EvaluatorListParams &&
            id == other.id &&
            datasetId == other.datasetId &&
            evaluatorId == other.evaluatorId &&
            includeBackfillProgress == other.includeBackfillProgress &&
    ...
    override fun toString() =
        "EvaluatorListParams{id=$id, datasetId=$datasetId, evaluatorId=$evaluatorId, includeBackfillProgress=$includeBackfillProgress, nameContains=$nameContains, sessionId=$sessionId, tagValueId=$tagValueId, type=$type, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
