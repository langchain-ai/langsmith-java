...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PendingIdentity].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(pendingIdentity: PendingIdentity) = apply {
            ...
            createdAt = pendingIdentity.createdAt
            email = pendingIdentity.email
            accessScope = pendingIdentity.accessScope
            fullName = pendingIdentity.fullName
            orgRoleId = pendingIdentity.orgRoleId
            orgRoleName = pendingIdentity.orgRoleName
            organizationId = pendingIdentity.organizationId
            password = pendingIdentity.password
            readOnly = pendingIdentity.readOnly
            roleId = pendingIdentity.roleId
            roleName = pendingIdentity.roleName
            tenantId = pendingIdentity.tenantId
            userId = pendingIdentity.userId
            workspaceIds = pendingIdentity.workspaceIds.map { it.toMutableList() }
            workspaceRoleId = pendingIdentity.workspaceRoleId
            additionalProperties = pendingIdentity.additionalProperties.toMutableMap()
        }
