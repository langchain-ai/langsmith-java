...
private constructor(
    ...
    /** A builder for [RunRetrieveV2Params]. */
    ...
    class Select @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val LS_USER_ID = of("LS_USER_ID")
