...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RunQueryPageResponse].
         *
    ...
    /** A builder for [RunQueryPageResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(runQueryPageResponse: RunQueryPageResponse) = apply {
            cursors = runQueryPageResponse.cursors
            runs = runQueryPageResponse.runs.map { it.toMutableList() }
            parsedQuery = runQueryPageResponse.parsedQuery
            searchCursors = runQueryPageResponse.searchCursors
            additionalProperties = runQueryPageResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RunQueryPageResponse].
         *
         ...
         */
        fun build(): RunQueryPageResponse =
            RunQueryPageResponse(
     ...
     *   expected type.
     */
    fun validate(): RunQueryPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RunQueryPageResponse &&
    ...
    override fun toString() =
        "RunQueryPageResponse{cursors=$cursors, runs=$runs, parsedQuery=$parsedQuery, searchCursors=$searchCursors, additionalProperties=$additionalProperties}"
}
