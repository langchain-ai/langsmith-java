...
class PersonalAccessTokenPersonalAccessTokensParams
private constructor(
     ...
     */
    fun apiKeyCreateRequest(): ApiKeyCreateRequest = apiKeyCreateRequest

    fun _additionalBodyProperties(): Map<String, JsonValue> =
        apiKeyCreateRequest._additionalProperties()
    ...
    companion object {
         ...
         * [PersonalAccessTokenPersonalAccessTokensParams].
         *
    ...
    /** A builder for [PersonalAccessTokenPersonalAccessTokensParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            apiKeyCreateRequest = personalAccessTokenPersonalAccessTokensParams.apiKeyCreateRequest
            additionalHeaders =
                personalAccessTokenPersonalAccessTokensParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                personalAccessTokenPersonalAccessTokensParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PersonalAccessTokenPersonalAccessTokensParams].
         *
         ...
         */
        fun build(): PersonalAccessTokenPersonalAccessTokensParams =
            PersonalAccessTokenPersonalAccessTokensParams(
                checkRequired("apiKeyCreateRequest", apiKeyCreateRequest),
                additionalHeaders.build(),
                additionalQueryParams.build(),
            )
    }

    fun _body(): ApiKeyCreateRequest = apiKeyCreateRequest
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PersonalAccessTokenPersonalAccessTokensParams &&
    ...
    override fun toString() =
        "PersonalAccessTokenPersonalAccessTokensParams{apiKeyCreateRequest=$apiKeyCreateRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
