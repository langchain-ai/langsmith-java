 ...
 */
class OtelTraceExporter private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun fromEnv(): OtelTraceExporter = fromConfig(OtelConfig.fromEnv())
        ...
        fun fromConfig(config: OtelConfig): OtelTraceExporter {
            ...
            logger.debug("Created OpenTelemetry SDK with endpoint: {}, timeout: {}", config.endpoint, config.timeout)
    ...
    class Builder {
        ...
        fun build(): OtelTraceExporter {
            val finalConfig = config ?: OtelConfig.builder()
