...
interface SectionService {
    ...
    fun retrieve(sectionId: String, params: SectionRetrieveParams): CustomChartsSection =
    ...
    /** @see retrieve */
    fun retrieve(params: SectionRetrieveParams): CustomChartsSection =
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /api/v1/org-charts/section/{section_id}`, but is
         * otherwise the same as [SectionService.retrieve].
         */
        @MustBeClosed
        fun retrieve(
            sectionId: String,
            params: SectionRetrieveParams,
        ): HttpResponseFor<CustomChartsSection> = retrieve(sectionId, params, RequestOptions.none())
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: SectionRetrieveParams): HttpResponseFor<CustomChartsSection> =
            retrieve(params, RequestOptions.none())
