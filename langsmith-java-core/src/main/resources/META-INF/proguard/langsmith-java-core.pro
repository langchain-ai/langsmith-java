...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.langchain.smith.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.langchain.smith.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.langchain.smith.** {
    <init>(...);
