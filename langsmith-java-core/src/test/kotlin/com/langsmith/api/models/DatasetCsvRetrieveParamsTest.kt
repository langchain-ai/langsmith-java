...
class DatasetCsvRetrieveParamsTest { // templates/JavaSDK/entities/params.ts:907:13 //
    // templates/JavaSDK/entities/params.ts:907:13 //
    // templates/JavaSDK/entities/params.ts:907:13

    @Test // templates/JavaSDK/entities/testing.ts:18:13 //
    // templates/JavaSDK/entities/params.ts:907:13
    fun createDatasetCsvRetrieveParams() { // templates/JavaSDK/entities/testing.ts:18:13
        DatasetCsvRetrieveParams.builder() // templates/JavaSDK/entities/params.ts:916:21 //
    ...
    fun getQueryParams() { // templates/JavaSDK/entities/testing.ts:18:13
        val params =
            DatasetCsvRetrieveParams.builder() // templates/JavaSDK/entities/params.ts:954:10 //
    ...
    fun getPathParam() { // templates/JavaSDK/entities/testing.ts:18:13
        val params =
            DatasetCsvRetrieveParams.builder() // templates/JavaSDK/entities/params.ts:1072:10 //
