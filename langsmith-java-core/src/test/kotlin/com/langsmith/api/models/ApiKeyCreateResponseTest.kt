...
class ApiKeyCreateResponseTest { // templates/JavaSDK/entities/objects.ts:645:15 //
    // templates/JavaSDK/entities/objects.ts:645:15 //
    // templates/JavaSDK/entities/objects.ts:645:15

    @Test // templates/JavaSDK/entities/testing.ts:18:13 //
    // templates/JavaSDK/entities/objects.ts:645:15
    fun createApiKeyCreateResponse() { // templates/JavaSDK/entities/testing.ts:18:13
        val apiKeyCreateResponse =
            ApiKeyCreateResponse.builder() // templates/JavaSDK/entities/objects.ts:657:10 //
