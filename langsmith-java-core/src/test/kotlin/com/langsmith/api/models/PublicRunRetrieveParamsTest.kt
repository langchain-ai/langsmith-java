...
class PublicRunRetrieveParamsTest { // templates/JavaSDK/entities/params.ts:907:13 //
    // templates/JavaSDK/entities/params.ts:907:13 //
    // templates/JavaSDK/entities/params.ts:907:13

    @Test // templates/JavaSDK/entities/testing.ts:18:13 //
    // templates/JavaSDK/entities/params.ts:907:13
    fun createPublicRunRetrieveParams() { // templates/JavaSDK/entities/testing.ts:18:13
        PublicRunRetrieveParams.builder() // templates/JavaSDK/entities/params.ts:916:21 //
    ...
    fun getPathParam() { // templates/JavaSDK/entities/testing.ts:18:13
        val params =
            PublicRunRetrieveParams.builder() // templates/JavaSDK/entities/params.ts:1072:10 //
