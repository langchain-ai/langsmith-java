...
class FeedbackDeleteParamsTest { // templates/JavaSDK/entities/params.ts:907:13 //
    // templates/JavaSDK/entities/params.ts:907:13 //
    // templates/JavaSDK/entities/params.ts:907:13

    @Test // templates/JavaSDK/entities/testing.ts:18:13 //
    // templates/JavaSDK/entities/params.ts:907:13
    fun createFeedbackDeleteParams() { // templates/JavaSDK/entities/testing.ts:18:13
        FeedbackDeleteParams.builder() // templates/JavaSDK/entities/params.ts:916:21 //
    ...
    fun getPathParam() { // templates/JavaSDK/entities/testing.ts:18:13
        val params =
            FeedbackDeleteParams.builder() // templates/JavaSDK/entities/params.ts:1072:10 //
