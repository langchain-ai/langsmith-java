...
class FeedbackRetrieveParamsTest { // templates/JavaSDK/entities/params.ts:907:13 //
    // templates/JavaSDK/entities/params.ts:907:13 //
    // templates/JavaSDK/entities/params.ts:907:13

    @Test // templates/JavaSDK/entities/testing.ts:18:13 //
    // templates/JavaSDK/entities/params.ts:907:13
    fun createFeedbackRetrieveParams() { // templates/JavaSDK/entities/testing.ts:18:13
        FeedbackRetrieveParams.builder() // templates/JavaSDK/entities/params.ts:916:21 //
    ...
    fun getPathParam() { // templates/JavaSDK/entities/testing.ts:18:13
        val params =
            FeedbackRetrieveParams.builder() // templates/JavaSDK/entities/params.ts:1072:10 //
