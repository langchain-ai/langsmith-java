...
class PublicExampleListParamsTest { // templates/JavaSDK/entities/params.ts:907:13 //
    // templates/JavaSDK/entities/params.ts:907:13 //
    // templates/JavaSDK/entities/params.ts:907:13

    @Test // templates/JavaSDK/entities/testing.ts:18:13 //
    // templates/JavaSDK/entities/params.ts:907:13
    fun createPublicExampleListParams() { // templates/JavaSDK/entities/testing.ts:18:13
        PublicExampleListParams.builder() // templates/JavaSDK/entities/params.ts:916:21 //
    ...
    fun getQueryParams() { // templates/JavaSDK/entities/testing.ts:18:13
        val params =
            PublicExampleListParams.builder() // templates/JavaSDK/entities/params.ts:954:10 //
    ...
    fun getPathParam() { // templates/JavaSDK/entities/testing.ts:18:13
        val params =
            PublicExampleListParams.builder() // templates/JavaSDK/entities/params.ts:1072:10 //
