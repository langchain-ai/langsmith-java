...
class PendingIdentityTest { // templates/JavaSDK/entities/objects.ts:645:15 //
    // templates/JavaSDK/entities/objects.ts:645:15 //
    // templates/JavaSDK/entities/objects.ts:645:15

    @Test // templates/JavaSDK/entities/testing.ts:18:13 //
    // templates/JavaSDK/entities/objects.ts:645:15
    fun createPendingIdentity() { // templates/JavaSDK/entities/testing.ts:18:13
        val pendingIdentity =
            PendingIdentity.builder() // templates/JavaSDK/entities/objects.ts:657:10 //
