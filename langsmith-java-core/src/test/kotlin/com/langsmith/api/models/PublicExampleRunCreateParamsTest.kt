...
class PublicExampleRunCreateParamsTest { // templates/JavaSDK/entities/params.ts:907:13 //
    // templates/JavaSDK/entities/params.ts:907:13 //
    // templates/JavaSDK/entities/params.ts:907:13

    @Test // templates/JavaSDK/entities/testing.ts:18:13 //
    // templates/JavaSDK/entities/params.ts:907:13
    fun createPublicExampleRunCreateParams() { // templates/JavaSDK/entities/testing.ts:18:13
        PublicExampleRunCreateParams.builder() // templates/JavaSDK/entities/params.ts:916:21 //
    ...
    fun getBody() { // templates/JavaSDK/entities/testing.ts:18:13
        ...
        assertThat(body.filters()).isEqualTo(PublicExampleRunCreateParams.Filters.builder().build())
