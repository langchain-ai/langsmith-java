...
class PublicDatasetRunRetrieveParamsTest { // templates/JavaSDK/entities/params.ts:907:13 //
    // templates/JavaSDK/entities/params.ts:907:13 //
    // templates/JavaSDK/entities/params.ts:907:13

    @Test // templates/JavaSDK/entities/testing.ts:18:13 //
    // templates/JavaSDK/entities/params.ts:907:13
    fun createPublicDatasetRunRetrieveParams() { // templates/JavaSDK/entities/testing.ts:18:13
        PublicDatasetRunRetrieveParams.builder() // templates/JavaSDK/entities/params.ts:916:21 //
