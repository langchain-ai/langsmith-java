    ...
    fun callRetrieve() { // templates/JavaSDK/entities/testing.ts:18:13
        val client =
            LangSmithOkHttpClient.builder() // templates/JavaSDK/services.ts:308:18 //
                ...
                .build()
        val csvService = client.datasets().csv()
        val datasetCsvRetrieveResponse =
            csvService.retrieve(
                DatasetCsvRetrieveParams.builder() // templates/JavaSDK/services.ts:464:26 //
        ...
        println(datasetCsvRetrieveResponse)
    }
}
