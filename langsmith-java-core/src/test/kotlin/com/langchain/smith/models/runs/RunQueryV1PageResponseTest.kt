...
internal class RunQueryV1PageResponseTest {

    @Test
    fun create() {
        val runQueryV1PageResponse =
            RunQueryV1PageResponse.builder()
                .cursors(RunQueryV1PageResponse.Cursors.builder().next("next").build())
                .addRun(
                    RunSchema.builder()
                ...
                .searchCursors(
                    RunQueryV1PageResponse.SearchCursors.builder()
                        .putAdditionalProperty("foo", JsonValue.from("bar"))
                        .build()
                )
                .build()

        assertThat(runQueryV1PageResponse.cursors())
            .isEqualTo(RunQueryV1PageResponse.Cursors.builder().next("next").build())
        assertThat(runQueryV1PageResponse.runs())
            .containsExactly(
                RunSchema.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .appPath("app_path")
        ...
        assertThat(runQueryV1PageResponse.parsedQuery()).contains("parsed_query")
        assertThat(runQueryV1PageResponse.searchCursors())
            .contains(
                RunQueryV1PageResponse.SearchCursors.builder()
                    .putAdditionalProperty("foo", JsonValue.from("bar"))
                    .build()
    ...
    fun roundtrip() {
        ...
        val roundtrippedRunQueryV1PageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(runQueryV1PageResponse),
                jacksonTypeRef<RunQueryV1PageResponse>(),
            )

        assertThat(roundtrippedRunQueryV1PageResponse).isEqualTo(runQueryV1PageResponse)
    }
}
