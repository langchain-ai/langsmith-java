    ...
    fun create() {
        val registryResponse =
            RegistryResponse.builder()
                ...
                .name("name")
                .provider(RegistryResponse.Provider.DOCKER_REGISTRY)
                .repositorySearchMode(RegistryResponse.RepositorySearchMode.GLOBAL)
        ...
        assertThat(registryResponse.provider()).contains(RegistryResponse.Provider.DOCKER_REGISTRY)
        assertThat(registryResponse.repositorySearchMode())
            .contains(RegistryResponse.RepositorySearchMode.GLOBAL)
