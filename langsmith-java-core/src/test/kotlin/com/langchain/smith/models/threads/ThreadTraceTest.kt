...
internal class ThreadTraceTest {
    ...
    fun create() {
        ...
        assertThat(threadTrace.error()).contains("context deadline exceeded")
        ...
        assertThat(threadTrace._inputs()).isEqualTo(JsonValue.from(mapOf<String, Any>()))
        ...
        assertThat(threadTrace._outputs()).isEqualTo(JsonValue.from(mapOf<String, Any>()))
