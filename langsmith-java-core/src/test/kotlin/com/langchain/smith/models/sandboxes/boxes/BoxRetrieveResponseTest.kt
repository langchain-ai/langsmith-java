    ...
    fun create() {
        val boxRetrieveResponse =
            BoxRetrieveResponse.builder()
                ...
                .memBytes(0L)
                .addMount(
                    BoxRetrieveResponse.Mount.SandboxapiS3BucketMountSpec.builder()
                        .id("id")
                        .mountPath("mount_path")
                        .s3(
                            BoxRetrieveResponse.Mount.SandboxapiS3BucketMountSpec.S3.builder()
                                .bucket("bucket")
                        ...
                        .type(BoxRetrieveResponse.Mount.SandboxapiS3BucketMountSpec.Type.S3)
                        .cache(
                            BoxRetrieveResponse.Mount.SandboxapiS3BucketMountSpec.Cache.builder()
                                .maxSizeBytes(0L)
                                .writebackSeconds(0L)
                                .build()
                        )
        ...
        assertThat(boxRetrieveResponse.mounts().getOrNull())
            .containsExactly(
                BoxRetrieveResponse.Mount.ofSandboxapiS3BucketMountSpec(
                    BoxRetrieveResponse.Mount.SandboxapiS3BucketMountSpec.builder()
                        .id("id")
                        .mountPath("mount_path")
                        .s3(
