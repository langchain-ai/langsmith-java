    ...
    fun create() {
        val tracerSessionWithoutVirtualFields =
            TracerSessionWithoutVirtualFields.builder()
                ...
                .extra(
                    TracerSessionWithoutVirtualFields.Extra.builder()
                ...
                .traceTier(TracerSessionWithoutVirtualFields.TraceTier.LONGLIVED)
                .build()
        ...
        assertThat(tracerSessionWithoutVirtualFields.extra())
            .contains(
                TracerSessionWithoutVirtualFields.Extra.builder()
                    .putAdditionalProperty("foo", JsonValue.from("bar"))
                    .build()
        ...
        assertThat(tracerSessionWithoutVirtualFields.startTime())
            .contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(tracerSessionWithoutVirtualFields.traceTier())
            .contains(TracerSessionWithoutVirtualFields.TraceTier.LONGLIVED)
    }
