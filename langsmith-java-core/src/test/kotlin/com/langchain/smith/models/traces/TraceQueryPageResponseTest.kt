...
internal class TraceQueryPageResponseTest {

    @Test
    fun create() {
        val traceQueryPageResponse =
            TraceQueryPageResponse.builder()
                .addItem(
                    Trace.builder()
                        .rootRun(
                            Run.builder()
                                        ...
                                        .putAdditionalProperty(
                                            ...
                                            JsonValue.from(
                                                mapOf(
                                                    "avg" to 0.87,
                                                    "comments" to
                                                        listOf("good answer", "needs citation"),
        ...
        assertThat(traceQueryPageResponse.items().getOrNull())
            .containsExactly(
                Trace.builder()
                    .rootRun(
                        Run.builder()
        ...
        assertThat(traceQueryPageResponse.nextCursor()).contains("next_cursor")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedTraceQueryPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(traceQueryPageResponse),
                jacksonTypeRef<TraceQueryPageResponse>(),
            )

        assertThat(roundtrippedTraceQueryPageResponse).isEqualTo(traceQueryPageResponse)
    }
}
