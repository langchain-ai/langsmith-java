    ...
    fun create() {
        val tracerSession =
            TracerSession.builder()
                ...
                .feedbackStats(
                    TracerSession.FeedbackStats.builder()
                        .putAdditionalProperty("foo", JsonValue.from("bar"))
                        .build()
                )
                .firstTokenP50(0.0)
                ...
                .runCount(0L)
                .addRunFacet(
                    TracerSession.RunFacet.builder()
                        .putAdditionalProperty("foo", JsonValue.from("bar"))
                        .build()
                )
                .sessionFeedbackStats(
                    TracerSession.SessionFeedbackStats.builder()
                        .putAdditionalProperty("foo", JsonValue.from("bar"))
                        .build()
                )
        ...
        assertThat(tracerSession.feedbackStats())
            .contains(
                TracerSession.FeedbackStats.builder()
                    .putAdditionalProperty("foo", JsonValue.from("bar"))
                    .build()
        ...
        assertThat(tracerSession.sessionFeedbackStats())
            .contains(
                TracerSession.SessionFeedbackStats.builder()
                    .putAdditionalProperty("foo", JsonValue.from("bar"))
                    .build()
