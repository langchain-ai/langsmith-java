    ...
    fun create() {
        val annotationQueueRetrieveResponse =
            AnnotationQueueRetrieveResponse.builder()
                ...
                .addAssignedReviewer(
                    AnnotationQueueRetrieveResponse.AssignedReviewer.builder()
                        .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                        .email("email")
                        .name("name")
                        .build()
        ...
        assertThat(annotationQueueRetrieveResponse.tenantId())
            .isEqualTo("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(annotationQueueRetrieveResponse.assignedReviewers().getOrNull())
            .containsExactly(
                AnnotationQueueRetrieveResponse.AssignedReviewer.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .email("email")
        ...
        assertThat(annotationQueueRetrieveResponse.reviewerAccessMode())
