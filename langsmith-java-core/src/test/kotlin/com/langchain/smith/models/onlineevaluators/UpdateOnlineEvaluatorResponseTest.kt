...
internal class UpdateOnlineEvaluatorResponseTest {

    @Test
    fun create() {
        val updateOnlineEvaluatorResponse =
            UpdateOnlineEvaluatorResponse.builder()
                .evaluator(
        ...
        assertThat(updateOnlineEvaluatorResponse.evaluator())
            .contains(
                OnlineEvaluator.builder()
                    .id("id")
                    .codeEvaluator(
    ...
    fun roundtrip() {
        ...
        val roundtrippedUpdateOnlineEvaluatorResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(updateOnlineEvaluatorResponse),
                jacksonTypeRef<UpdateOnlineEvaluatorResponse>(),
            )

        assertThat(roundtrippedUpdateOnlineEvaluatorResponse)
            .isEqualTo(updateOnlineEvaluatorResponse)
    }
}
