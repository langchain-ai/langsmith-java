...
internal class CreateRepoResponseTest {
    ...
    fun create() {
            ...
            CreateRepoResponse.builder()
                .repo(
                    RepoWithLookups.builder()
                        ...
                        .repoType(RepoWithLookups.RepoType.PROMPT)
                        .addTag("string")
                        ...
                        .readme("readme")
                        .restrictedMode(true)
                        .source(RepoWithLookups.Source.INTERNAL)
        ...
        assertThat(createRepoResponse.repo())
            .isEqualTo(
                RepoWithLookups.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedCreateRepoResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(createRepoResponse),
                jacksonTypeRef<CreateRepoResponse>(),
            )

        assertThat(roundtrippedCreateRepoResponse).isEqualTo(createRepoResponse)
    }
}
