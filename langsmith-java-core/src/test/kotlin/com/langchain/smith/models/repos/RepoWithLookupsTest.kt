...
internal class RepoWithLookupsTest {
    ...
    fun create() {
        ...
        assertThat(repoWithLookups.repoType()).isEqualTo(RepoWithLookups.RepoType.PROMPT)
        ...
        assertThat(repoWithLookups.owners().getOrNull())
            .containsExactly(
                RepoWithLookups.Owner.builder()
                    .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .email("email")
        ...
        assertThat(repoWithLookups.restrictedMode()).contains(true)
        assertThat(repoWithLookups.source()).contains(RepoWithLookups.Source.INTERNAL)
