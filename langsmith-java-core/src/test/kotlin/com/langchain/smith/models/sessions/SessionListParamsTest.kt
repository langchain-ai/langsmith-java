...
internal class SessionListParamsTest {
    ...
    fun create() {
        SessionListParams.builder()
            ...
            .sortByFeedbackSource(SessionListParams.SortByFeedbackSource.SESSION)
        ...
        assertThat(queryParams)
            .isEqualTo(
                QueryParams.builder()
                    ...
                    .put("offset", "0")
                    .put("reference_dataset", "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .put("reference_dataset", "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .put("reference_free", "true")
                    .put("sort_by", "name")
                    .put("sort_by_desc", "true")
                    .put("sort_by_feedback_key", "sort_by_feedback_key")
                    .put("sort_by_feedback_source", "session")
