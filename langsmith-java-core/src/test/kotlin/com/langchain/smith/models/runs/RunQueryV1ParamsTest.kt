...
internal class RunQueryV1ParamsTest {
    ...
    fun create() {
        RunQueryV1Params.builder()
            ...
            .isRoot(true)
            .limit(1L)
            .order(RunQueryV1Params.Order.ASC)
    ...
    fun body() {
        ...
        assertThat(body.dataSourceType()).contains(RunsFilterDataSourceTypeEnum.CURRENT)
        ...
        assertThat(body.order()).contains(RunQueryV1Params.Order.ASC)
        ...
        assertThat(body.runType()).contains(RunTypeEnum.TOOL)
        assertThat(body.searchFilter()).contains("search_filter")
        assertThat(body.select().getOrNull()).containsExactly(RunQueryV1Params.Select.ID)
    ...
    fun bodyWithoutOptionalFields() {
        val params = RunQueryV1Params.builder().build()
