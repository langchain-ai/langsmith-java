    ...
    fun create() {
        val boxCreateResponse =
            BoxCreateResponse.builder()
                ...
                .memBytes(0L)
                .addMount(
                    BoxCreateResponse.Mount.SandboxapiS3BucketMountSpec.builder()
                        .id("id")
                        .mountPath("mount_path")
                        .s3(
                            BoxCreateResponse.Mount.SandboxapiS3BucketMountSpec.S3.builder()
                                .bucket("bucket")
                        ...
                        .type(BoxCreateResponse.Mount.SandboxapiS3BucketMountSpec.Type.S3)
                        .cache(
                            BoxCreateResponse.Mount.SandboxapiS3BucketMountSpec.Cache.builder()
                                .maxSizeBytes(0L)
                                .writebackSeconds(0L)
                                .build()
                        )
        ...
        assertThat(boxCreateResponse.mounts().getOrNull())
            .containsExactly(
                BoxCreateResponse.Mount.ofSandboxapiS3BucketMountSpec(
                    BoxCreateResponse.Mount.SandboxapiS3BucketMountSpec.builder()
                        .id("id")
                        .mountPath("mount_path")
                        .s3(
