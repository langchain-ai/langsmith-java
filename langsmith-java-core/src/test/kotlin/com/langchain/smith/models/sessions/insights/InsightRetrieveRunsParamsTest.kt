...
internal class InsightRetrieveRunsParamsTest {
    ...
    fun queryParams() {
        ...
        assertThat(queryParams)
            .isEqualTo(
                QueryParams.builder()
                    .put("attribute_sort_key", "attribute_sort_key")
                    .put("attribute_sort_order", "asc")
                    .put("cluster_id", "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .put("limit", "1")
                    .put("offset", "0")
                    .build()
            )
