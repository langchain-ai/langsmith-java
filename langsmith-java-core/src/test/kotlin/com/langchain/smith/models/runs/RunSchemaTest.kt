...
internal class RunSchemaTest {
    ...
    fun create() {
        ...
        assertThat(runSchema.inputsS3Urls())
            .contains(
                RunSchema.InputsS3Urls.builder()
                    .putAdditionalProperty("foo", JsonValue.from("bar"))
                    .build()
        ...
        assertThat(runSchema.messages().getOrNull())
            .containsExactly(
                RunSchema.Message.builder()
                    .putAdditionalProperty("foo", JsonValue.from("bar"))
                    .build()
            )
        assertThat(runSchema.outputs())
            .contains(
                RunSchema.Outputs.builder()
                    .putAdditionalProperty("foo", JsonValue.from("bar"))
                    .build()
        ...
        assertThat(runSchema.outputsS3Urls())
            .contains(
                RunSchema.OutputsS3Urls.builder()
                    .putAdditionalProperty("foo", JsonValue.from("bar"))
                    .build()
        ...
        assertThat(runSchema.s3Urls())
            .contains(
                RunSchema.S3Urls.builder()
                    .putAdditionalProperty("foo", JsonValue.from("bar"))
                    .build()
            )
        assertThat(runSchema.serialized())
            .contains(
                RunSchema.Serialized.builder()
                    .putAdditionalProperty("foo", JsonValue.from("bar"))
                    .build()
