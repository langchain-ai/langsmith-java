...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(insightRetrieveParams: InsightRetrieveParams) = apply {
            sessionId = insightRetrieveParams.sessionId
            jobId = insightRetrieveParams.jobId
            clusterId = insightRetrieveParams.clusterId
    ...
    override fun hashCode(): Int =
        Objects.hash(sessionId, jobId, clusterId, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "InsightRetrieveParams{sessionId=$sessionId, jobId=$jobId, clusterId=$clusterId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
