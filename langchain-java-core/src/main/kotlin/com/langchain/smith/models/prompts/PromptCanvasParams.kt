    ...
    private constructor(
        ...
        interface Visitor<out T> {
            ...
            fun unknown(json: JsonValue?): T {
                throw LangChainInvalidDataException("Unknown Message: $json")
            }
        }
        ...
        private constructor(
            ...
            private constructor(
                ...
                interface Visitor<out T> {
                     ...
                     */
                    fun unknown(json: JsonValue?): T {
                        throw LangChainInvalidDataException("Unknown Content: $json")
                    }
                }
        ...
        private constructor(
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                fun known(): Known =
                    when (this) {
                        LAST -> Known.LAST
                        else -> throw LangChainInvalidDataException("Unknown ChunkPosition: $value")
                    }
    ...
    class TemplateFormat @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        fun known(): Known =
            when (this) {
                ...
                else -> throw LangChainInvalidDataException("Unknown TemplateFormat: $value")
            }
    ...
    class ArtifactLength @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        fun known(): Known =
            when (this) {
                ...
                else -> throw LangChainInvalidDataException("Unknown ArtifactLength: $value")
            }
    ...
    class ReadingLevel @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        fun known(): Known =
            when (this) {
                ...
                PHD -> Known.PHD
                else -> throw LangChainInvalidDataException("Unknown ReadingLevel: $value")
            }
