...
class PromptWebhookPromptWebhooksParams
private constructor(
    ...
    companion object {
         ...
         * [PromptWebhookPromptWebhooksParams].
         *
    ...
    /** A builder for [PromptWebhookPromptWebhooksParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(promptWebhookPromptWebhooksParams: PromptWebhookPromptWebhooksParams) =
            apply {
                body = promptWebhookPromptWebhooksParams.body.toBuilder()
                additionalHeaders = promptWebhookPromptWebhooksParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    promptWebhookPromptWebhooksParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [PromptWebhookPromptWebhooksParams].
         *
         ...
         */
        fun build(): PromptWebhookPromptWebhooksParams =
            PromptWebhookPromptWebhooksParams(
                body.build(),
    ...
    private constructor(
        ...
        ) : this(url, id, excludePrompts, headers, includePrompts, triggers, mutableMapOf())
        ...
        override fun toString() =
            "Body{url=$url, id=$id, excludePrompts=$excludePrompts, headers=$headers, includePrompts=$includePrompts, triggers=$triggers, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PromptWebhookPromptWebhooksParams &&
            body == other.body &&
    ...
    override fun toString() =
        "PromptWebhookPromptWebhooksParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
