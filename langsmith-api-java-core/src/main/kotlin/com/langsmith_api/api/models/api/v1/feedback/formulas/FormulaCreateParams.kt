...
private constructor(
    ...
    /** A builder for [FormulaCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(formulaCreateParams: FormulaCreateParams) = apply {
            body = formulaCreateParams.body.toBuilder()
            additionalHeaders = formulaCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = formulaCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FormulaCreateParams].
         *
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{aggregationType=$aggregationType, feedbackKey=$feedbackKey, formulaParts=$formulaParts, datasetId=$datasetId, sessionId=$sessionId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FormulaCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "FormulaCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
