...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun promptName(): String = body.promptName()
     ...
     */
    fun _promptName(): JsonField<String> = body._promptName()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RepoOptimizeJobParams].
         *
    ...
    /** A builder for [RepoOptimizeJobParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(repoOptimizeJobParams: RepoOptimizeJobParams) = apply {
            body = repoOptimizeJobParams.body.toBuilder()
            additionalHeaders = repoOptimizeJobParams.additionalHeaders.toBuilder()
            additionalQueryParams = repoOptimizeJobParams.additionalQueryParams.toBuilder()
        }
        ...
        fun promptName(promptName: String) = apply { body.promptName(promptName) }
         ...
         * value.
         */
        fun promptName(promptName: JsonField<String>) = apply { body.promptName(promptName) }
        ...
        /**
         * Returns an immutable instance of [RepoOptimizeJobParams].
         *
         ...
         */
        fun build(): RepoOptimizeJobParams =
    ...
    private constructor(
        ...
        ) : this(algorithm, config, promptName, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(algorithm, config, promptName, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{algorithm=$algorithm, config=$config, promptName=$promptName, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RepoOptimizeJobParams &&
            body == other.body &&
    ...
    override fun toString() =
        "RepoOptimizeJobParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
