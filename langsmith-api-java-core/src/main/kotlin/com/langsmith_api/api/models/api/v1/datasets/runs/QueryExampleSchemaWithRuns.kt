...
private constructor(
    ...
    private val sortParams: JsonField<SortParams>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        sortParams: JsonField<SortParams> = JsonMissing.of(),
    ) : this(
        sessionIds,
     ...
     *   the server responded with an unexpected value).
     */
    fun sortParams(): Optional<SortParams> = sortParams.getOptional("sort_params")
    ...
    @JsonProperty("sort_params")
    @ExcludeMissing
    fun _sortParams(): JsonField<SortParams> = sortParams
    ...
    class Builder internal constructor() {
        ...
        private var sortParams: JsonField<SortParams> = JsonMissing.of()
        ...
        fun sortParams(sortParams: SortParams?) = sortParams(JsonField.ofNullable(sortParams))

        /** Alias for calling [Builder.sortParams] with `sortParams.orElse(null)`. */
        fun sortParams(sortParams: Optional<SortParams>) = sortParams(sortParams.getOrNull())

        /**
         * Sets [Builder.sortParams] to an arbitrary JSON value.
         *
         * You should usually call [Builder.sortParams] with a well-typed [SortParams] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sortParams(sortParams: JsonField<SortParams>) = apply { this.sortParams = sortParams }
    ...
    class Format @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        fun known(): Known =
            when (this) {
                CSV -> Known.CSV
                else -> throw LangsmithApiInvalidDataException("Unknown Format: $value")
            }
    ...
    private constructor(
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [SortParams].
             *
             * The following fields are required:
             * ```java
             * .sortBy()
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(sortParams: SortParams) = apply {
                sortBy = sortParams.sortBy
                sortOrder = sortParams.sortOrder
                additionalProperties = sortParams.additionalProperties.toMutableMap()
            }
            ...
            /**
             * Returns an immutable instance of [SortParams].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
        ...
        class SortOrder @JsonCreator private constructor(private val value: JsonField<String>) :
            Enum {
            ...
            enum class Value {
                ...
                DESC,
                /**
                 * An enum member indicating that [SortOrder] was instantiated with an unknown
                 * value.
                 */
                _UNKNOWN,
            }
             ...
             *
             * @throws LangsmithApiInvalidDataException if this class instance's value is a not a
             *   known member.
             */
            fun known(): Known =
                when (this) {
                    ASC -> Known.ASC
                    DESC -> Known.DESC
                    else -> throw LangsmithApiInvalidDataException("Unknown SortOrder: $value")
                }
             ...
             *
             * @throws LangsmithApiInvalidDataException if this class instance's value does not have
        ...
        override fun toString() =
            "SortParams{sortBy=$sortBy, sortOrder=$sortOrder, additionalProperties=$additionalProperties}"
    }
