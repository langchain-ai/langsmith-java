...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(v1UpdateParams: V1UpdateParams) = apply {
            owner = v1UpdateParams.owner
            repo = v1UpdateParams.repo
    ...
    override fun toString() =
        "V1UpdateParams{owner=$owner, repo=$repo, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
