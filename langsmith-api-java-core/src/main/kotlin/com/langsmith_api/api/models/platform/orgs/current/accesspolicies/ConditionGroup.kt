        ...
        class AttributeName @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            fun known(): Known =
                when (this) {
                    ...
                    else -> throw LangsmithApiInvalidDataException("Unknown AttributeName: $value")
                }
        ...
        class Operator @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            fun known(): Known =
                when (this) {
                    ...
                    else -> throw LangsmithApiInvalidDataException("Unknown Operator: $value")
                }
    ...
    class Permission @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        fun known(): Known =
            when (this) {
                ...
                else -> throw LangsmithApiInvalidDataException("Unknown Permission: $value")
            }
