...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): MemberUpdateBasicParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [MemberUpdateBasicParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MemberUpdateBasicParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(memberUpdateBasicParams: MemberUpdateBasicParams) = apply {
            body = memberUpdateBasicParams.body.toBuilder()
            additionalHeaders = memberUpdateBasicParams.additionalHeaders.toBuilder()
            additionalQueryParams = memberUpdateBasicParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [MemberUpdateBasicParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MemberUpdateBasicParams =
    ...
    private constructor(
        ...
        ) : this(fullName, password, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(fullName, password, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy { Objects.hash(fullName, password, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{fullName=$fullName, password=$password, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MemberUpdateBasicParams &&
            body == other.body &&
    ...
    override fun toString() =
        "MemberUpdateBasicParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
