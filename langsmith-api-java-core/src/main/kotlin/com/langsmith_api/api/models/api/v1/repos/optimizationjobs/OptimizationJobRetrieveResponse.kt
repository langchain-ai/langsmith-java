...
import com.langsmith_api.api.models.api.v1.repos.DemoConfig
...
class OptimizationJobRetrieveResponse
...
private constructor(
    ...
    private val logs: JsonField<List<PromptOptimizationJobLog>>,
    ...
    private constructor(
        ...
        @JsonProperty("logs")
        @ExcludeMissing
        logs: JsonField<List<PromptOptimizationJobLog>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun logs(): List<PromptOptimizationJobLog> = logs.getRequired("logs")
    ...
    @JsonProperty("logs")
    @ExcludeMissing
    fun _logs(): JsonField<List<PromptOptimizationJobLog>> = logs
    ...
    /** A builder for [OptimizationJobRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        private var logs: JsonField<MutableList<PromptOptimizationJobLog>>? = null
        ...
        @JvmSynthetic
        internal fun from(optimizationJobRetrieveResponse: OptimizationJobRetrieveResponse) =
            apply {
                id = optimizationJobRetrieveResponse.id
                algorithm = optimizationJobRetrieveResponse.algorithm
                config = optimizationJobRetrieveResponse.config
                createdAt = optimizationJobRetrieveResponse.createdAt
                logs = optimizationJobRetrieveResponse.logs.map { it.toMutableList() }
                repoId = optimizationJobRetrieveResponse.repoId
                status = optimizationJobRetrieveResponse.status
                tenantId = optimizationJobRetrieveResponse.tenantId
                updatedAt = optimizationJobRetrieveResponse.updatedAt
                results = optimizationJobRetrieveResponse.results.map { it.toMutableList() }
                additionalProperties =
                    optimizationJobRetrieveResponse.additionalProperties.toMutableMap()
            }
        ...
        fun logs(logs: List<PromptOptimizationJobLog>) = logs(JsonField.of(logs))

        /**
         * Sets [Builder.logs] to an arbitrary JSON value.
         *
         * You should usually call [Builder.logs] with a well-typed `List<PromptOptimizationJobLog>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun logs(logs: JsonField<List<PromptOptimizationJobLog>>) = apply {
            this.logs = logs.map { it.toMutableList() }
        }

        /**
         * Adds a single [PromptOptimizationJobLog] to [logs].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addLog(log: PromptOptimizationJobLog) = apply {
        ...
        /**
         * Returns an immutable instance of [OptimizationJobRetrieveResponse].
         *
         ...
         */
        fun build(): OptimizationJobRetrieveResponse =
            OptimizationJobRetrieveResponse(
                checkRequired("id", id),
    ...
    fun validate(): OptimizationJobRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        interface Visitor<out T> {
            ...
            fun unknown(json: JsonValue?): T {
                throw LangsmithApiInvalidDataException("Unknown Config: $json")
            }
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OptimizationJobRetrieveResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "OptimizationJobRetrieveResponse{id=$id, algorithm=$algorithm, config=$config, createdAt=$createdAt, logs=$logs, repoId=$repoId, status=$status, tenantId=$tenantId, updatedAt=$updatedAt, results=$results, additionalProperties=$additionalProperties}"
}
