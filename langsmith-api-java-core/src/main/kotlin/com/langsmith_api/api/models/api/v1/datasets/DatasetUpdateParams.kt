...
private constructor(
    ...
    private constructor(
        ...
        interface Visitor<out T> {
             ...
             */
            fun unknown(json: JsonValue?): T {
                throw LangsmithApiInvalidDataException("Unknown InputsSchemaDefinition: $json")
            }
        }
    ...
    private constructor(
        ...
        interface Visitor<out T> {
             ...
             */
            fun unknown(json: JsonValue?): T {
                throw LangsmithApiInvalidDataException("Unknown Metadata: $json")
            }
        }
    ...
    private constructor(
        ...
        interface Visitor<out T> {
             ...
             */
            fun unknown(json: JsonValue?): T {
                throw LangsmithApiInvalidDataException("Unknown Name: $json")
            }
        }
    ...
    private constructor(
        ...
        interface Visitor<out T> {
             ...
             */
            fun unknown(json: JsonValue?): T {
                throw LangsmithApiInvalidDataException("Unknown OutputsSchemaDefinition: $json")
            }
        }
    ...
    private constructor(
        ...
        interface Visitor<out T> {
             ...
             */
            fun unknown(json: JsonValue?): T {
                throw LangsmithApiInvalidDataException("Unknown Transformations: $json")
            }
        }
