...
private constructor(
    ...
    private val createRunClusteringJobRequest: CreateRunClusteringJobRequest,
    ...
    fun _additionalBodyProperties(): Map<String, JsonValue> =
        createRunClusteringJobRequest._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        private var createRunClusteringJobRequest: CreateRunClusteringJobRequest? = null
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        @JvmSynthetic
        internal fun from(insightCreateParams: InsightCreateParams) = apply {
            sessionId = insightCreateParams.sessionId
            createRunClusteringJobRequest = insightCreateParams.createRunClusteringJobRequest
        ...
        fun build(): InsightCreateParams =
            InsightCreateParams(
                sessionId,
                checkRequired("createRunClusteringJobRequest", createRunClusteringJobRequest),
                additionalHeaders.build(),
                additionalQueryParams.build(),
            )
    }

    fun _body(): CreateRunClusteringJobRequest = createRunClusteringJobRequest
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InsightCreateParams &&
            ...
            createRunClusteringJobRequest == other.createRunClusteringJobRequest &&
    ...
    override fun toString() =
        "InsightCreateParams{sessionId=$sessionId, createRunClusteringJobRequest=$createRunClusteringJobRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
