...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrgChartUpdateParams].
         *
    ...
    /** A builder for [OrgChartUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orgChartUpdateParams: OrgChartUpdateParams) = apply {
            chartId = orgChartUpdateParams.chartId
            customChartUpdate = orgChartUpdateParams.customChartUpdate
            additionalHeaders = orgChartUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = orgChartUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OrgChartUpdateParams].
         *
         ...
         */
        fun build(): OrgChartUpdateParams =
            OrgChartUpdateParams(
                chartId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrgChartUpdateParams &&
    ...
    override fun toString() =
        "OrgChartUpdateParams{chartId=$chartId, customChartUpdate=$customChartUpdate, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
