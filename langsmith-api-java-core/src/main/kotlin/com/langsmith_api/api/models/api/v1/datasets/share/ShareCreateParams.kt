...
package com.langsmith_api.api.models.api.v1.datasets.share
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(shareCreateParams: ShareCreateParams) = apply {
            datasetId = shareCreateParams.datasetId
            shareProjects = shareCreateParams.shareProjects
            ...
            additionalBodyProperties = shareCreateParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Alias for [Builder.shareProjects].
         *
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun shareProjects(shareProjects: Boolean) = shareProjects(shareProjects as Boolean?)

        /** Alias for calling [Builder.shareProjects] with `shareProjects.orElse(null)`. */
        fun shareProjects(shareProjects: Optional<Boolean>) =
            shareProjects(shareProjects.getOrNull())
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                shareProjects?.let { put("share_projects", it.toString()) }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ShareCreateParams &&
            ...
            shareProjects == other.shareProjects &&
    ...
    override fun toString() =
        "ShareCreateParams{datasetId=$datasetId, shareProjects=$shareProjects, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
