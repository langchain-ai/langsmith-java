...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CustomChartsRequestBase]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CustomChartsRequestBase]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customChartsRequestBase: CustomChartsRequestBase) = apply {
            endTime = customChartsRequestBase.endTime
            omitData = customChartsRequestBase.omitData
            startTime = customChartsRequestBase.startTime
            stride = customChartsRequestBase.stride
            timezone = customChartsRequestBase.timezone
            additionalProperties = customChartsRequestBase.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CustomChartsRequestBase].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CustomChartsRequestBase =
    ...
    fun validate(): CustomChartsRequestBase = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomChartsRequestBase &&
    ...
    override fun toString() =
        "CustomChartsRequestBase{endTime=$endTime, omitData=$omitData, startTime=$startTime, stride=$stride, timezone=$timezone, additionalProperties=$additionalProperties}"
}
