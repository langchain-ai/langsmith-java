...
class DatasetRetrieveJsonlParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DatasetRetrieveJsonlParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DatasetRetrieveJsonlParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(datasetRetrieveJsonlParams: DatasetRetrieveJsonlParams) = apply {
            datasetId = datasetRetrieveJsonlParams.datasetId
            asOf = datasetRetrieveJsonlParams.asOf
            additionalHeaders = datasetRetrieveJsonlParams.additionalHeaders.toBuilder()
            additionalQueryParams = datasetRetrieveJsonlParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DatasetRetrieveJsonlParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DatasetRetrieveJsonlParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DatasetRetrieveJsonlParams &&
    ...
    override fun toString() =
        "DatasetRetrieveJsonlParams{datasetId=$datasetId, asOf=$asOf, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
