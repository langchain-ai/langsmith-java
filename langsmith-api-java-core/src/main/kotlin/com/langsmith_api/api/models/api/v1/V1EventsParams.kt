...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [V1EventsParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v1EventsParams: V1EventsParams) = apply {
            body = v1EventsParams.body.toBuilder()
            additionalHeaders = v1EventsParams.additionalHeaders.toBuilder()
            additionalQueryParams = v1EventsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [V1EventsParams].
         *
         ...
         */
        fun build(): V1EventsParams =
            V1EventsParams(body.build(), additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        fun known(): Known =
            when (this) {
                ...
                else -> throw LangsmithApiInvalidDataException("Unknown EventType: $value")
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is V1EventsParams &&
            body == other.body &&
    ...
    override fun toString() =
        "V1EventsParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
