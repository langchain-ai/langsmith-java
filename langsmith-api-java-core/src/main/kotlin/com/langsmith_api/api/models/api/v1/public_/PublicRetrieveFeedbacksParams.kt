...
package com.langsmith_api.api.models.api.v1.public_
...
class PublicRetrieveFeedbacksParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PublicRetrieveFeedbacksParams = builder().build()
    ...
    /** A builder for [PublicRetrieveFeedbacksParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicRetrieveFeedbacksParams: PublicRetrieveFeedbacksParams) = apply {
            shareToken = publicRetrieveFeedbacksParams.shareToken
            hasComment = publicRetrieveFeedbacksParams.hasComment
            hasScore = publicRetrieveFeedbacksParams.hasScore
            key = publicRetrieveFeedbacksParams.key?.toMutableList()
            level = publicRetrieveFeedbacksParams.level
            limit = publicRetrieveFeedbacksParams.limit
            offset = publicRetrieveFeedbacksParams.offset
            run = publicRetrieveFeedbacksParams.run?.toMutableList()
            session = publicRetrieveFeedbacksParams.session?.toMutableList()
            source = publicRetrieveFeedbacksParams.source?.toMutableList()
            user = publicRetrieveFeedbacksParams.user?.toMutableList()
            additionalHeaders = publicRetrieveFeedbacksParams.additionalHeaders.toBuilder()
            additionalQueryParams = publicRetrieveFeedbacksParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PublicRetrieveFeedbacksParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PublicRetrieveFeedbacksParams =
            PublicRetrieveFeedbacksParams(
                shareToken,
                hasComment,
                hasScore,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicRetrieveFeedbacksParams &&
    ...
    override fun toString() =
        "PublicRetrieveFeedbacksParams{shareToken=$shareToken, hasComment=$hasComment, hasScore=$hasScore, key=$key, level=$level, limit=$limit, offset=$offset, run=$run, session=$session, source=$source, user=$user, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
