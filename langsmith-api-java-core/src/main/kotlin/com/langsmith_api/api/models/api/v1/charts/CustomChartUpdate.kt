...
private constructor(
    ...
    private constructor(
        ...
        interface Visitor<out T> {
            ...
            fun unknown(json: JsonValue?): T {
                throw LangsmithApiInvalidDataException("Unknown ChartType: $json")
            }
        }
    ...
    private constructor(
        ...
        interface Visitor<out T> {
             ...
             */
            fun unknown(json: JsonValue?): T {
                throw LangsmithApiInvalidDataException("Unknown CommonFilters: $json")
            }
        }
    ...
    private constructor(
        ...
        interface Visitor<out T> {
             ...
             */
            fun unknown(json: JsonValue?): T {
                throw LangsmithApiInvalidDataException("Unknown SectionId: $json")
            }
        }
    ...
    private constructor(
        ...
        interface Visitor<out T> {
             ...
             */
            fun unknown(json: JsonValue?): T {
                throw LangsmithApiInvalidDataException("Unknown Series: $json")
            }
        }
