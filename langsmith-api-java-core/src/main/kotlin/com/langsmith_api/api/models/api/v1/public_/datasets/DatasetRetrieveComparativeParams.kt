...
class DatasetRetrieveComparativeParams
private constructor(
    ...
    /** A builder for [DatasetRetrieveComparativeParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(datasetRetrieveComparativeParams: DatasetRetrieveComparativeParams) =
            apply {
                shareToken = datasetRetrieveComparativeParams.shareToken
                limit = datasetRetrieveComparativeParams.limit
                name = datasetRetrieveComparativeParams.name
                nameContains = datasetRetrieveComparativeParams.nameContains
                offset = datasetRetrieveComparativeParams.offset
                sortBy = datasetRetrieveComparativeParams.sortBy
                sortByDesc = datasetRetrieveComparativeParams.sortByDesc
                additionalHeaders = datasetRetrieveComparativeParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    datasetRetrieveComparativeParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [DatasetRetrieveComparativeParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DatasetRetrieveComparativeParams =
            DatasetRetrieveComparativeParams(
                shareToken,
                limit,
                name,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DatasetRetrieveComparativeParams &&
    ...
    override fun toString() =
        "DatasetRetrieveComparativeParams{shareToken=$shareToken, limit=$limit, name=$name, nameContains=$nameContains, offset=$offset, sortBy=$sortBy, sortByDesc=$sortByDesc, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
