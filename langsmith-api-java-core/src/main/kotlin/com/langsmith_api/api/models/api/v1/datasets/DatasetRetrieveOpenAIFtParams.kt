...
class DatasetRetrieveOpenAIFtParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DatasetRetrieveOpenAIFtParams = builder().build()
    ...
    /** A builder for [DatasetRetrieveOpenAIFtParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(datasetRetrieveOpenAIFtParams: DatasetRetrieveOpenAIFtParams) = apply {
            datasetId = datasetRetrieveOpenAIFtParams.datasetId
            asOf = datasetRetrieveOpenAIFtParams.asOf
            additionalHeaders = datasetRetrieveOpenAIFtParams.additionalHeaders.toBuilder()
            additionalQueryParams = datasetRetrieveOpenAIFtParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DatasetRetrieveOpenAIFtParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DatasetRetrieveOpenAIFtParams =
            DatasetRetrieveOpenAIFtParams(
                datasetId,
                asOf,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DatasetRetrieveOpenAIFtParams &&
    ...
    override fun toString() =
        "DatasetRetrieveOpenAIFtParams{datasetId=$datasetId, asOf=$asOf, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
