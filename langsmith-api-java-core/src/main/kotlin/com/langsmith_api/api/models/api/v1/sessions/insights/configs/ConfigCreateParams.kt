...
private constructor(
     ...
     */
    fun config(): CreateRunClusteringJobRequest = body.config()
    ...
    /** A builder for [ConfigCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(configCreateParams: ConfigCreateParams) = apply {
            sessionId = configCreateParams.sessionId
            body = configCreateParams.body.toBuilder()
            additionalHeaders = configCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = configCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ConfigCreateParams].
         *
    ...
    private constructor(
        ...
        ) : this(config, name, description, mutableMapOf())
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun config(): CreateRunClusteringJobRequest = config.getRequired("config")
        ...
        class Builder internal constructor() {
            ...
            private var config: JsonField<CreateRunClusteringJobRequest>? = null
        ...
        private val hashCode: Int by lazy {
            Objects.hash(config, name, description, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{config=$config, name=$name, description=$description, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConfigCreateParams &&
    ...
    override fun toString() =
        "ConfigCreateParams{sessionId=$sessionId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
