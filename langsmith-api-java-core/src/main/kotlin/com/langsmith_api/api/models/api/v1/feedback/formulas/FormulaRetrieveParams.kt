...
private constructor(
    ...
    /** A builder for [FormulaRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(formulaRetrieveParams: FormulaRetrieveParams) = apply {
            feedbackFormulaId = formulaRetrieveParams.feedbackFormulaId
            additionalHeaders = formulaRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = formulaRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FormulaRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FormulaRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FormulaRetrieveParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(feedbackFormulaId, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "FormulaRetrieveParams{feedbackFormulaId=$feedbackFormulaId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
