...
class AccessScope @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    fun known(): Known =
        when (this) {
            ...
            else -> throw LangsmithApiInvalidDataException("Unknown AccessScope: $value")
        }
