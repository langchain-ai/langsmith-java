...
package com.langsmith_api.api.core

import com.fasterxml.jackson.databind.json.JsonMapper
import com.langsmith_api.api.core.http.Headers
import com.langsmith_api.api.core.http.HttpClient
import com.langsmith_api.api.core.http.PhantomReachableClosingHttpClient
import com.langsmith_api.api.core.http.QueryParams
import com.langsmith_api.api.core.http.RetryingHttpClient
...
private constructor(
     ...
     *
     * Use the one published in `langsmith-api-java-client-okhttp` or implement your own.
     *
     ...
     *
     * Defaults to [com.langsmith_api.api.core.jsonMapper]. The default is usually sufficient and
    ...
    class Builder internal constructor() {
         ...
         */
        fun fromEnv() = apply {
            (System.getProperty("langsmithapi.baseUrl") ?: System.getenv("LANGSMITH_API_BASE_URL"))
                ?.let { baseUrl(it) }
            (System.getProperty("langsmithapi.apiKey") ?: System.getenv("LANGSMITH_API_API_KEY"))
                ?.let { apiKey(it) }
            (System.getProperty("langsmithapi.tenantId")
                    ?: System.getenv("LANGSMITH_API_TENANT_ID"))
                ?.let { tenantId(it) }
            (System.getProperty("langsmithapi.bearerToken")
                    ?: System.getenv("LANGSMITH_API_BEARER_TOKEN"))
                ?.let { bearerToken(it) }
            (System.getProperty("langsmithapi.organizationId")
                    ?: System.getenv("LANGSMITH_API_ORGANIZATION_ID"))
