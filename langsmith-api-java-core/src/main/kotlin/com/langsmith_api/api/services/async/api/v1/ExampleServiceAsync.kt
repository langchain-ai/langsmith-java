...
interface ExampleServiceAsync {
     ...
     */
    fun update(datasetId: String, params: ExampleUpdateParams): CompletableFuture<List<Example>> =
    ...
    /** @see update */
    fun update(params: ExampleUpdateParams): CompletableFuture<List<Example>> =
    ...
    interface WithRawResponse {
         ...
         * otherwise the same as [ExampleServiceAsync.update].
         */
        fun update(
            datasetId: String,
            params: ExampleUpdateParams,
        ...
        /** @see update */
        fun update(params: ExampleUpdateParams): CompletableFuture<HttpResponseFor<List<Example>>> =
            update(params, RequestOptions.none())
