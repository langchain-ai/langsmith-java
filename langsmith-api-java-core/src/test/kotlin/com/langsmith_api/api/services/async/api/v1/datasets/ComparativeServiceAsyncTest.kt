...
internal class ComparativeServiceAsyncTest {
    ...
    fun create() {
        val client =
            LangsmithApiOkHttpClientAsync.builder()
                ...
                .build()
        val comparativeServiceAsync = client.api().v1().datasets().comparative()
    ...
    fun list() {
        ...
        val comparativesFuture =
            comparativeServiceAsync.list(
        ...
        val comparatives = comparativesFuture.get()
