    ...
    fun list() {
        val client =
            LangsmithApiOkHttpClientAsync.builder()
                ...
                .build()
        val pendingServiceAsync = client.api().v1().workspaces().pending()

        val appSchemasTenantsFuture = pendingServiceAsync.list()

        val appSchemasTenants = appSchemasTenantsFuture.get()
