...
internal class PendingServiceAsyncTest {
    ...
    fun list() {
        val client =
            LangsmithApiOkHttpClientAsync.builder()
                ...
                .build()
        val pendingServiceAsync = client.api().v1().orgs().pending()

        val organizationPgSchemaSlimsFuture = pendingServiceAsync.list()
    ...
    fun claim() {
        ...
        val identityFuture = pendingServiceAsync.claim("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
