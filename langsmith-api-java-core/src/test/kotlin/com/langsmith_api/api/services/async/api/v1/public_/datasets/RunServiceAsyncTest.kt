...
internal class RunServiceAsyncTest {
    ...
    fun retrieve() {
        val client =
            LangsmithApiOkHttpClientAsync.builder()
                ...
                .build()
        val runServiceAsync = client.api().v1().public_().datasets().runs()

        val runPublicDatasetSchemaFuture =
        ...
        val runPublicDatasetSchema = runPublicDatasetSchemaFuture.get()
    ...
    fun stats() {
        ...
        val runStats = runStatsFuture.get()
        runStats.validate()
    }
}
