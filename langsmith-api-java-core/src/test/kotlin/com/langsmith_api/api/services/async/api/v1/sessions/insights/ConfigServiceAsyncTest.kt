    ...
    fun create() {
        val client =
            LangsmithApiOkHttpClientAsync.builder()
                ...
                .build()
        val configServiceAsync = client.api().v1().sessions().insights().configs()

        val createClusteringJobConfigResponseFuture =
        ...
        val createClusteringJobConfigResponse = createClusteringJobConfigResponseFuture.get()
