...
internal class ServiceKeyServiceAsyncTest {
    ...
    fun delete() {
        val client =
            LangsmithApiOkHttpClientAsync.builder()
                ...
                .build()
        val serviceKeyServiceAsync = client.api().v1().orgs().current().serviceKeys()

        val apiKeyGetResponseFuture =
            serviceKeyServiceAsync.delete("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    fun retrieveServiceKeys() {
        ...
        val apiKeyGetResponsesFuture = serviceKeyServiceAsync.retrieveServiceKeys()
    ...
    fun serviceKeys() {
        ...
        val apiKeyCreateResponseFuture =
            serviceKeyServiceAsync.serviceKeys(
