...
internal class ShareServiceTest {
    ...
    fun create() {
        val client =
            LangsmithApiOkHttpClient.builder()
                ...
                .build()
        val shareService = client.api().v1().runs().share()

        val runShareSchema = shareService.create("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    fun list() {
        ...
        val runShareSchema = shareService.list("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
