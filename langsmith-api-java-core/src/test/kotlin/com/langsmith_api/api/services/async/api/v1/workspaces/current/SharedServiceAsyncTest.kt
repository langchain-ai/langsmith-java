...
internal class SharedServiceAsyncTest {
    ...
    fun list() {
        val client =
            LangsmithApiOkHttpClientAsync.builder()
                ...
                .build()
        val sharedServiceAsync = client.api().v1().workspaces().current().shared()

        val sharedsFuture =
            sharedServiceAsync.list(SharedListParams.builder().limit(1L).offset(0L).build())

        val shareds = sharedsFuture.get()
        shareds.validate()
    }
