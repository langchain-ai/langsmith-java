...
internal class SectionUpdateParamsTest {
    ...
    fun pathParams() {
        val params =
            SectionUpdateParams.builder()
                .sectionId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                .customChartsSectionUpdate(CustomChartsSectionUpdate.builder().build())
                .build()
    ...
    fun bodyWithoutOptionalFields() {
        ...
        assertThat(body).isEqualTo(CustomChartsSectionUpdate.builder().build())
    }
}
