...
import com.langsmith_api.api.client.LangsmithApiClientAsyncImpl
...
/**
 * A class that allows building an instance of [LangsmithApiClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class LangsmithApiOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [LangsmithApiClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): LangsmithApiClientAsync = builder().fromEnv().build()
    }

    /** A builder for [LangsmithApiOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [LangsmithApiClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LangsmithApiClientAsync =
            LangsmithApiClientAsyncImpl(
                clientOptions
                    .httpClient(
