...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ServiceAccountDeleteResponse].
         *
    ...
    /** A builder for [ServiceAccountDeleteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(serviceAccountDeleteResponse: ServiceAccountDeleteResponse) = apply {
            id = serviceAccountDeleteResponse.id
            createdAt = serviceAccountDeleteResponse.createdAt
            defaultWorkspaceId = serviceAccountDeleteResponse.defaultWorkspaceId
            name = serviceAccountDeleteResponse.name
            organizationId = serviceAccountDeleteResponse.organizationId
            updatedAt = serviceAccountDeleteResponse.updatedAt
            additionalProperties = serviceAccountDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ServiceAccountDeleteResponse].
         *
         ...
         */
        fun build(): ServiceAccountDeleteResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ServiceAccountDeleteResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "ServiceAccountDeleteResponse{id=$id, createdAt=$createdAt, defaultWorkspaceId=$defaultWorkspaceId, name=$name, organizationId=$organizationId, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
