...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(commentListParams: CommentListParams) = apply {
            owner = commentListParams.owner
            repo = commentListParams.repo
            limit = commentListParams.limit
            offset = commentListParams.offset
    ...
    override fun toString() =
        "CommentListParams{owner=$owner, repo=$repo, limit=$limit, offset=$offset, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
