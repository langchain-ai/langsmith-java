...
private constructor(
    ...
    private val type: FilterViewType?,
    ...
    fun type(): Optional<FilterViewType> = Optional.ofNullable(type)
    ...
    class Builder internal constructor() {
        ...
        private var type: FilterViewType? = null
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        @JvmSynthetic
        internal fun from(viewListParams: ViewListParams) = apply {
            sessionId = viewListParams.sessionId
            type = viewListParams.type
        ...
        fun type(type: FilterViewType?) = apply { this.type = type }
    ...
    override fun hashCode(): Int =
        Objects.hash(sessionId, type, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ViewListParams{sessionId=$sessionId, type=$type, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
