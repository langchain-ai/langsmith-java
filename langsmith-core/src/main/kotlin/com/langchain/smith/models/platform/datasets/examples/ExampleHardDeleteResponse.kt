...
class ExampleHardDeleteResponse
...
private constructor(
    ...
    /** A builder for [ExampleHardDeleteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(exampleHardDeleteResponse: ExampleHardDeleteResponse) = apply {
            count = exampleHardDeleteResponse.count
            exampleIds = exampleHardDeleteResponse.exampleIds.map { it.toMutableList() }
            additionalProperties = exampleHardDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExampleHardDeleteResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ExampleHardDeleteResponse =
    ...
    fun validate(): ExampleHardDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExampleHardDeleteResponse &&
            count == other.count &&
    ...
    override fun toString() =
        "ExampleHardDeleteResponse{count=$count, exampleIds=$exampleIds, additionalProperties=$additionalProperties}"
}
