...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [TagListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TagListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tagListParams: TagListParams) = apply {
            hasCommits = tagListParams.hasCommits
            isArchived = tagListParams.isArchived
            isPublic = tagListParams.isPublic
            limit = tagListParams.limit
            offset = tagListParams.offset
            query = tagListParams.query
            tagValueId = tagListParams.tagValueId?.toMutableList()
            tags = tagListParams.tags?.toMutableList()
            tenantHandle = tagListParams.tenantHandle
            tenantId = tagListParams.tenantId
            upstreamRepoHandle = tagListParams.upstreamRepoHandle
            upstreamRepoOwner = tagListParams.upstreamRepoOwner
            additionalHeaders = tagListParams.additionalHeaders.toBuilder()
            additionalQueryParams = tagListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TagListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TagListParams =
            TagListParams(
                hasCommits,
                isArchived,
                isPublic,
