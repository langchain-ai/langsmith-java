...
private constructor(
     ...
     */
    fun _tagName(): JsonField<String> = body._tagName()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(tagCreateParams: TagCreateParams) = apply {
            owner = tagCreateParams.owner
            repo = tagCreateParams.repo
        ...
        fun tagName(tagName: String) = apply { body.tagName(tagName) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun tagName(tagName: JsonField<String>) = apply { body.tagName(tagName) }
    ...
    private constructor(
        ...
        private val hashCode: Int by lazy {
            Objects.hash(commitId, tagName, skipWebhooks, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{commitId=$commitId, tagName=$tagName, skipWebhooks=$skipWebhooks, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "TagCreateParams{owner=$owner, repo=$repo, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
