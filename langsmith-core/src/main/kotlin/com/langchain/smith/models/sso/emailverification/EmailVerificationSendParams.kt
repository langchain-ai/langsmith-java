...
class EmailVerificationSendParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmailVerificationSendParams].
         *
    ...
    /** A builder for [EmailVerificationSendParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emailVerificationSendParams: EmailVerificationSendParams) = apply {
            body = emailVerificationSendParams.body.toBuilder()
            additionalHeaders = emailVerificationSendParams.additionalHeaders.toBuilder()
            additionalQueryParams = emailVerificationSendParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EmailVerificationSendParams].
         *
         ...
         */
        fun build(): EmailVerificationSendParams =
            EmailVerificationSendParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmailVerificationSendParams &&
            body == other.body &&
    ...
    override fun toString() =
        "EmailVerificationSendParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
