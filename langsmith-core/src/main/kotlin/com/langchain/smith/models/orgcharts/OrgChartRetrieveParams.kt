...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrgChartRetrieveParams].
         *
    ...
    /** A builder for [OrgChartRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orgChartRetrieveParams: OrgChartRetrieveParams) = apply {
            chartId = orgChartRetrieveParams.chartId
            customChartsRequest = orgChartRetrieveParams.customChartsRequest
            additionalHeaders = orgChartRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = orgChartRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OrgChartRetrieveParams].
         *
         ...
         */
        fun build(): OrgChartRetrieveParams =
            OrgChartRetrieveParams(
                chartId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrgChartRetrieveParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(chartId, customChartsRequest, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "OrgChartRetrieveParams{chartId=$chartId, customChartsRequest=$customChartsRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
