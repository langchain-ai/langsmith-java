...
private constructor(
    ...
    /** A builder for [AppSchemasTenant]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(appSchemasTenant: AppSchemasTenant) = apply {
            id = appSchemasTenant.id
            createdAt = appSchemasTenant.createdAt
            displayName = appSchemasTenant.displayName
            isDeleted = appSchemasTenant.isDeleted
            isPersonal = appSchemasTenant.isPersonal
            organizationId = appSchemasTenant.organizationId
            tenantHandle = appSchemasTenant.tenantHandle
            additionalProperties = appSchemasTenant.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AppSchemasTenant].
         *
    ...
    fun validate(): AppSchemasTenant = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AppSchemasTenant &&
            id == other.id &&
    ...
    override fun toString() =
        "AppSchemasTenant{id=$id, createdAt=$createdAt, displayName=$displayName, isDeleted=$isDeleted, isPersonal=$isPersonal, organizationId=$organizationId, tenantHandle=$tenantHandle, additionalProperties=$additionalProperties}"
}
