...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AnnotationQueueRetrieveParams = builder().build()
    ...
    override fun toString() =
        "AnnotationQueueRetrieveParams{queueId=$queueId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
