...
private constructor(
    ...
    /** A builder for [TagValueTagValuesParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tagValueTagValuesParams: TagValueTagValuesParams) = apply {
            tagKeyId = tagValueTagValuesParams.tagKeyId
            body = tagValueTagValuesParams.body.toBuilder()
            additionalHeaders = tagValueTagValuesParams.additionalHeaders.toBuilder()
            additionalQueryParams = tagValueTagValuesParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TagValueTagValuesParams].
         *
         ...
         */
        fun build(): TagValueTagValuesParams =
            TagValueTagValuesParams(
                tagKeyId,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TagValueTagValuesParams &&
    ...
    override fun toString() =
        "TagValueTagValuesParams{tagKeyId=$tagKeyId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
