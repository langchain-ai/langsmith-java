...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(apiKeyCreateResponse: ApiKeyCreateResponse) = apply {
            ...
            description = apiKeyCreateResponse.description
            key = apiKeyCreateResponse.key
            shortKey = apiKeyCreateResponse.shortKey
            createdAt = apiKeyCreateResponse.createdAt
            expiresAt = apiKeyCreateResponse.expiresAt
            lastUsedAt = apiKeyCreateResponse.lastUsedAt
            readOnly = apiKeyCreateResponse.readOnly
            workspaceNames = apiKeyCreateResponse.workspaceNames.map { it.toMutableList() }
    ...
    override fun toString() =
        "ApiKeyCreateResponse{id=$id, description=$description, key=$key, shortKey=$shortKey, createdAt=$createdAt, expiresAt=$expiresAt, lastUsedAt=$lastUsedAt, readOnly=$readOnly, workspaceNames=$workspaceNames, additionalProperties=$additionalProperties}"
}
