...
/** Update Model Price */
class ModelPriceMapUpdateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ModelPriceMapUpdateParams].
         *
    ...
    /** A builder for [ModelPriceMapUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(modelPriceMapUpdateParams: ModelPriceMapUpdateParams) = apply {
            id = modelPriceMapUpdateParams.id
            body = modelPriceMapUpdateParams.body.toBuilder()
            additionalHeaders = modelPriceMapUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = modelPriceMapUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ModelPriceMapUpdateParams].
         *
         ...
         */
        fun build(): ModelPriceMapUpdateParams =
            ModelPriceMapUpdateParams(
                id,
                body.build(),
    ...
    private constructor(
        ...
        interface Visitor<out T> {
            ...
            fun unknown(json: JsonValue?): T {
                throw LangsmithInvalidDataException("Unknown CompletionCost: $json")
            }
        }
    ...
    private constructor(
        ...
        interface Visitor<out T> {
             ...
             */
            fun unknown(json: JsonValue?): T {
                throw LangsmithInvalidDataException("Unknown PromptCost: $json")
            }
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ModelPriceMapUpdateParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "ModelPriceMapUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
