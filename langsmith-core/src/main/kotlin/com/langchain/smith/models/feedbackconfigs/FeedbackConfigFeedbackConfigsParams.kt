...
private constructor(
     ...
     */
    fun feedbackConfig(): FeedbackConfig = body.feedbackConfig()
    ...
    companion object {
         ...
         * [FeedbackConfigFeedbackConfigsParams].
         *
    ...
    /** A builder for [FeedbackConfigFeedbackConfigsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            feedbackConfigFeedbackConfigsParams: FeedbackConfigFeedbackConfigsParams
        ) = apply {
            body = feedbackConfigFeedbackConfigsParams.body.toBuilder()
            additionalHeaders = feedbackConfigFeedbackConfigsParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                feedbackConfigFeedbackConfigsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FeedbackConfigFeedbackConfigsParams].
         *
         ...
         */
        fun build(): FeedbackConfigFeedbackConfigsParams =
            FeedbackConfigFeedbackConfigsParams(
                body.build(),
    ...
    private constructor(
        ...
        ) : this(feedbackConfig, feedbackKey, isLowerScoreBetter, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(feedbackConfig, feedbackKey, isLowerScoreBetter, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{feedbackConfig=$feedbackConfig, feedbackKey=$feedbackKey, isLowerScoreBetter=$isLowerScoreBetter, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeedbackConfigFeedbackConfigsParams &&
            body == other.body &&
    ...
    override fun toString() =
        "FeedbackConfigFeedbackConfigsParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
