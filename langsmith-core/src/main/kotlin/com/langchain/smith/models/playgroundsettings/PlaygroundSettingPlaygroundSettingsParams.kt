...
class PlaygroundSettingPlaygroundSettingsParams
private constructor(
    ...
    companion object {
         ...
         * [PlaygroundSettingPlaygroundSettingsParams].
         *
    ...
    /** A builder for [PlaygroundSettingPlaygroundSettingsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            playgroundSettingPlaygroundSettingsParams: PlaygroundSettingPlaygroundSettingsParams
        ) = apply {
            body = playgroundSettingPlaygroundSettingsParams.body.toBuilder()
            additionalHeaders =
                playgroundSettingPlaygroundSettingsParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                playgroundSettingPlaygroundSettingsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PlaygroundSettingPlaygroundSettingsParams].
         *
         ...
         */
        fun build(): PlaygroundSettingPlaygroundSettingsParams =
            PlaygroundSettingPlaygroundSettingsParams(
                body.build(),
    ...
    private constructor(
        ...
        ) : this(settings, description, name, options, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(settings, description, name, options, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{settings=$settings, description=$description, name=$name, options=$options, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PlaygroundSettingPlaygroundSettingsParams &&
            body == other.body &&
    ...
    override fun toString() =
        "PlaygroundSettingPlaygroundSettingsParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
