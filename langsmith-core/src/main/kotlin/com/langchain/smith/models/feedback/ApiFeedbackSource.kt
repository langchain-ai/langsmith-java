...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ApiFeedbackSource]. */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(apiFeedbackSource: ApiFeedbackSource) = apply {
            metadata = apiFeedbackSource.metadata
            type = apiFeedbackSource.type
        ...
        /**
         * Returns an immutable instance of [ApiFeedbackSource].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ApiFeedbackSource =
            ApiFeedbackSource(metadata, type, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "ApiFeedbackSource{metadata=$metadata, type=$type, additionalProperties=$additionalProperties}"
}
