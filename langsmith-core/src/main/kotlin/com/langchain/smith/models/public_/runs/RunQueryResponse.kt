...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("runs")
        @ExcludeMissing
        runs: JsonField<List<RunPublicSchema>> = JsonMissing.of(),
     ...
     */
    @JsonProperty("runs") @ExcludeMissing fun _runs(): JsonField<List<RunPublicSchema>> = runs
    ...
    class Builder internal constructor() {
        ...
        private var runs: JsonField<MutableList<RunPublicSchema>>? = null
         ...
         *
         * You should usually call [Builder.runs] with a well-typed `List<RunPublicSchema>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun runs(runs: JsonField<List<RunPublicSchema>>) = apply {
            this.runs = runs.map { it.toMutableList() }
        }

        /**
         * Adds a single [RunPublicSchema] to [runs].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addRun(run: RunPublicSchema) = apply {
