...
private constructor(
    ...
    /** A builder for [TagValueUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tagValueUpdateParams: TagValueUpdateParams) = apply {
            tagKeyId = tagValueUpdateParams.tagKeyId
            tagValueId = tagValueUpdateParams.tagValueId
            body = tagValueUpdateParams.body.toBuilder()
            additionalHeaders = tagValueUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = tagValueUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TagValueUpdateParams].
         *
         ...
         */
        fun build(): TagValueUpdateParams =
            TagValueUpdateParams(
    ...
    private constructor(
        ...
        ) : this(description, value, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(description, value, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy { Objects.hash(description, value, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{description=$description, value=$value, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TagValueUpdateParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(tagKeyId, tagValueId, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "TagValueUpdateParams{tagKeyId=$tagKeyId, tagValueId=$tagValueId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
