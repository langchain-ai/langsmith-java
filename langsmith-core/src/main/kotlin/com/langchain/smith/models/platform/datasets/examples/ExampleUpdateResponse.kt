...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ExampleUpdateResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ExampleUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(exampleUpdateResponse: ExampleUpdateResponse) = apply {
            count = exampleUpdateResponse.count
            exampleIds = exampleUpdateResponse.exampleIds.map { it.toMutableList() }
            additionalProperties = exampleUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExampleUpdateResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ExampleUpdateResponse =
    ...
    fun validate(): ExampleUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExampleUpdateResponse &&
            count == other.count &&
    ...
    override fun toString() =
        "ExampleUpdateResponse{count=$count, exampleIds=$exampleIds, additionalProperties=$additionalProperties}"
}
