...
internal class OrgChartServiceAsyncTest {
    ...
    fun create() {
        val client =
            LangsmithOkHttpClientAsync.builder()
                ...
                .build()
        val orgChartServiceAsync = client.orgCharts()

        val customChartResponseFuture =
            orgChartServiceAsync.create(
    ...
    fun delete() {
        ...
        val orgChartFuture = orgChartServiceAsync.delete("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")

        val orgChart = orgChartFuture.get()
        orgChart.validate()
    }
